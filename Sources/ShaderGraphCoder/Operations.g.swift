...
import Foundation
public enum SGEnum0_model_object_world_tangent: String, CaseIterable {
    case model = "model"
    case object = "object"
    case tangent = "tangent"
    case world = "world"
}
public enum SGEnum1_box_gaussian: String, CaseIterable {
    case box = "box"
    case gaussian = "gaussian"
}
public enum SGEnum2_constant_clamp_periodic_mirror: String, CaseIterable {
    case clamp = "clamp"
    case constant = "constant"
    case mirror = "mirror"
    case periodic = "periodic"
}
public enum SGEnum3_closest_linear_cubic: String, CaseIterable {
    case closest = "closest"
    case cubic = "cubic"
    case linear = "linear"
}
public enum SGEnum4_tangent_object: String, CaseIterable {
    case object = "object"
    case tangent = "tangent"
}
public enum SGEnum5_model_object_world_unspecified: String, CaseIterable {
    case model = "model"
    case object = "object"
...
public func bitangent(space: SGEnum0_model_object_world_tangent, index: SGScalar) -> SGVector {
...
/// Blur
public func blur<T>(_ in1: T, size: SGScalar, filtertype: SGEnum1_box_gaussian) -> T where T: SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
...
/// Image
public func image<T>(file: SGTexture, defaultValue: T, texcoord: SGVector, uaddressmode: SGEnum2_constant_clamp_periodic_mirror, vaddressmode: SGEnum2_constant_clamp_periodic_mirror, filtertype: SGEnum3_closest_linear_cubic) -> T where T: SGNumeric {
...
public func normal(space: SGEnum0_model_object_world_tangent) -> SGVector {
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: SGString(source: .constant(.string(space.rawValue)))),
    ]
    return SGVector(source: .nodeOutput(SGNode(
...
public func normalmap(_ in1: SGVector, space: SGEnum4_tangent_object, scale: SGNumeric, normal: SGVector, tangent: SGVector) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
...
public func position(space: SGEnum0_model_object_world_tangent) -> SGVector {
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: SGString(source: .constant(.string(space.rawValue)))),
    ]
    return SGVector(source: .nodeOutput(SGNode(
...
/// Camera Position
public func cameraposition(space: SGEnum0_model_object_world_tangent) -> SGVector {
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: SGString(source: .constant(.string(space.rawValue)))),
    ]
    return SGVector(source: .nodeOutput(SGNode(
...
/// View Direction
public func viewdirection(space: SGEnum0_model_object_world_tangent) -> SGVector {
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: SGString(source: .constant(.string(space.rawValue)))),
    ]
    return SGVector(source: .nodeOutput(SGNode(
...
public func tangent(space: SGEnum0_model_object_world_tangent, index: SGScalar) -> SGVector {
    guard index.dataType == SGDataType.int else {
...
/// Tiled Image
public func tiledimage<T>(file: SGTexture, defaultValue: T, texcoord: SGVector, uvtiling: SGVector, uvoffset: SGVector, realworldimagesize: SGVector, realworldtilesize: SGVector, filtertype: SGEnum3_closest_linear_cubic) -> T where T: SGNumeric {
    guard file.dataType == SGDataType.asset else {
...
public func transformnormal(_ in1: SGVector, fromspace: SGEnum5_model_object_world_unspecified, tospace: SGEnum5_model_object_world_unspecified) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
...
public func transformpoint(_ in1: SGVector, fromspace: SGEnum5_model_object_world_unspecified, tospace: SGEnum5_model_object_world_unspecified) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
...
public func transformvector(_ in1: SGVector, fromspace: SGEnum5_model_object_world_unspecified, tospace: SGEnum5_model_object_world_unspecified) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
...
public func triplanarprojection<T>(filex: SGTexture, filey: SGTexture, filez: SGTexture, defaultValue: T, position: SGVector, normal: SGVector, filtertype: SGEnum3_closest_linear_cubic) -> T where T: SGNumeric {
...
public func updirection(space: SGEnum0_model_object_world_tangent) -> SGVector {
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: SGString(source: .constant(.string(space.rawValue)))),
    ]
    return SGVector(source: .nodeOutput(SGNode(
