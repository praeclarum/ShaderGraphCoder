...
/// Blur
public func blur<T>(_ in1: T, size: SGScalar, filtertype: SGBlurFilterType) -> T where T: SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
...
/// Image
public func image<T>(file: SGTexture, defaultValue: T, texcoord: SGVector, uaddressmode: SGAddressMode, vaddressmode: SGAddressMode, filtertype: SGFilterType) -> T where T: SGNumeric {
...
public func normal(space: SGSpace) -> SGVector {
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: SGString(source: .constant(.string(space.rawValue)))),
    ]
    return SGVector(source: .nodeOutput(SGNode(
...
public func normalmap(_ in1: SGVector, space: SGNormalSpace, scale: SGNumeric, normal: SGVector, tangent: SGVector) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
...
public func position(space: SGSpace) -> SGVector {
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: SGString(source: .constant(.string(space.rawValue)))),
    ]
    return SGVector(source: .nodeOutput(SGNode(
...
/// Camera Position
public func cameraposition(space: SGSpace) -> SGVector {
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: SGString(source: .constant(.string(space.rawValue)))),
    ]
    return SGVector(source: .nodeOutput(SGNode(
...
/// View Direction
public func viewdirection(space: SGSpace) -> SGVector {
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: SGString(source: .constant(.string(space.rawValue)))),
    ]
    return SGVector(source: .nodeOutput(SGNode(
...
/// Tiled Image
public func tiledimage<T>(file: SGTexture, defaultValue: T, texcoord: SGVector, uvtiling: SGVector, uvoffset: SGVector, realworldimagesize: SGVector, realworldtilesize: SGVector, filtertype: SGFilterType) -> T where T: SGNumeric {
    guard file.dataType == SGDataType.asset else {
...
public func triplanarprojection<T>(filex: SGTexture, filey: SGTexture, filez: SGTexture, defaultValue: T, position: SGVector, normal: SGVector, filtertype: SGFilterType) -> T where T: SGNumeric {
...
public func updirection(space: SGSpace) -> SGVector {
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: SGString(source: .constant(.string(space.rawValue)))),
    ]
    return SGVector(source: .nodeOutput(SGNode(
