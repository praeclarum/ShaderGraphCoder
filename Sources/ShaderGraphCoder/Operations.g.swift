...
public func UsdPrimvarReader(varname: SGString, fallback: SGValue) -> SGValue {
    guard varname.dataType == SGDataType.string else {
        return SGValueError("Invalid UsdPrimvarReader input. Expected varname data type to be SGDataType.string, but got \(varname.dataType).")
    }
    ...
    return SGVectorError("Unsupported input data types for UsdPrimvarReader")
}
public func UsdTransform2d(_ in1: SGVector, rotation: SGScalar, scale: SGVector, translation: SGVector) -> SGVector {
    guard in1.dataType == SGDataType.vector2f else {
        return SGVectorError("Invalid UsdTransform2d input. Expected in data type to be SGDataType.vector2f, but got \(in1.dataType).")
    }
    guard rotation.dataType == SGDataType.float else {
        return SGVectorError("Invalid UsdTransform2d input. Expected rotation data type to be SGDataType.float, but got \(rotation.dataType).")
    }
    guard scale.dataType == SGDataType.vector2f else {
        return SGVectorError("Invalid UsdTransform2d input. Expected scale data type to be SGDataType.vector2f, but got \(scale.dataType).")
    }
    guard translation.dataType == SGDataType.vector2f else {
        return SGVectorError("Invalid UsdTransform2d input. Expected translation data type to be SGDataType.vector2f, but got \(translation.dataType).")
    }
    let inputs: [SGNode.Input] = [
...
public func absval(_ in1: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    ...
    return SGVectorError("Unsupported input data types for absval")
}
public func acos(_ in1: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.float {
    ...
    return SGVectorError("Unsupported input data types for acos")
}
public func add(_ in1: SGValue, _ in2: SGValue) -> SGValue {
    ...
    return SGVectorError("Unsupported input data types for add")
}
public func ambientocclusion(coneangle: SGScalar, maxdistance: SGScalar) -> SGScalar {
    guard coneangle.dataType == SGDataType.float else {
        return SGScalarError("Invalid ambientocclusion input. Expected coneangle data type to be SGDataType.float, but got \(coneangle.dataType).")
    }
    guard maxdistance.dataType == SGDataType.float else {
        return SGScalarError("Invalid ambientocclusion input. Expected maxdistance data type to be SGDataType.float, but got \(maxdistance.dataType).")
    }
    let inputs: [SGNode.Input] = [
...
public func asin(_ in1: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.float {
    ...
    return SGVectorError("Unsupported input data types for asin")
}
public func atan2(iny: SGValue, inx: SGValue) -> SGValue {
    ...
    return SGVectorError("Unsupported input data types for atan2")
}
public func bitangent(space: SGString, index: SGScalar) -> SGVector {
    guard space.dataType == SGDataType.string else {
        return SGVectorError("Invalid bitangent input. Expected space data type to be SGDataType.string, but got \(space.dataType).")
    }
    guard index.dataType == SGDataType.int else {
        return SGVectorError("Invalid bitangent input. Expected index data type to be SGDataType.int, but got \(index.dataType).")
    }
    let inputs: [SGNode.Input] = [
...
public func blur(_ in1: SGValue, size: SGScalar, filtertype: SGString) -> SGValue {
    guard filtertype.dataType == SGDataType.string else {
        return SGValueError("Invalid blur input. Expected filtertype data type to be SGDataType.string, but got \(filtertype.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ...
    return SGVectorError("Unsupported input data types for blur")
}
public func burn(fg: SGValue, bg: SGValue, mix: SGScalar) -> SGValue {
    ...
    return SGScalarError("Unsupported input data types for burn")
}
public func ceil(_ in1: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.color3f {
    ...
    return SGVectorError("Unsupported input data types for ceil")
}
public func cellnoise2d(texcoord: SGVector) -> SGScalar {
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGScalarError("Invalid cellnoise2d input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    let inputs: [SGNode.Input] = [
...
public func cellnoise3d(position: SGVector) -> SGScalar {
    guard position.dataType == SGDataType.vector3f else {
        return SGScalarError("Invalid cellnoise3d input. Expected position data type to be SGDataType.vector3f, but got \(position.dataType).")
    }
    let inputs: [SGNode.Input] = [
...
public func clamp(_ in1: SGValue, low: SGValue, high: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ...
    return SGVectorError("Unsupported input data types for clamp")
}
public func contrast(_ in1: SGValue, amount: SGValue, pivot: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ...
    return SGVectorError("Unsupported input data types for contrast")
}
public func cos(_ in1: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.float {
    ...
    return SGVectorError("Unsupported input data types for cos")
}
public func crossproduct(_ in1: SGVector, _ in2: SGVector) -> SGVector {
    ...
    return SGVectorError("Unsupported input data types for crossproduct")
}
public func determinant(_ in1: SGMatrix) -> SGScalar {
    ...
    return SGScalarError("Unsupported input data types for determinant")
}
public func difference(fg: SGValue, bg: SGValue, mix: SGScalar) -> SGValue {
    ...
    return SGScalarError("Unsupported input data types for difference")
}
public func disjointover(fg: SGColor, bg: SGColor, mix: SGScalar) -> SGColor {
    guard fg.dataType == SGDataType.color4f else {
        return SGColorError("Invalid disjointover input. Expected fg data type to be SGDataType.color4f, but got \(fg.dataType).")
    }
    guard bg.dataType == SGDataType.color4f else {
        return SGColorError("Invalid disjointover input. Expected bg data type to be SGDataType.color4f, but got \(bg.dataType).")
    }
    guard mix.dataType == SGDataType.float else {
        return SGColorError("Invalid disjointover input. Expected mix data type to be SGDataType.float, but got \(mix.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
...
public func divide(_ in1: SGValue, _ in2: SGValue) -> SGValue {
    ...
    return SGVectorError("Unsupported input data types for divide")
}
public func dodge(fg: SGValue, bg: SGValue, mix: SGScalar) -> SGValue {
    ...
    return SGScalarError("Unsupported input data types for dodge")
}
public func dot(_ in1: SGValue, note: SGString) -> SGValue {
    guard note.dataType == SGDataType.string else {
        return SGValueError("Invalid dot input. Expected note data type to be SGDataType.string, but got \(note.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ...
    if in1.dataType == SGDataType.asset {
        return SGTexture(source: .nodeOutput(SGNode(
    ...
    return SGVectorError("Unsupported input data types for dot")
}
public func dotproduct(_ in1: SGVector, _ in2: SGVector) -> SGScalar {
    ...
    return SGScalarError("Unsupported input data types for dotproduct")
}
public func exp(_ in1: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.float {
    ...
    return SGVectorError("Unsupported input data types for exp")
}
public func extract(_ in1: SGValue, index: SGScalar) -> SGScalar {
    guard index.dataType == SGDataType.int else {
        return SGScalarError("Invalid extract input. Expected index data type to be SGDataType.int, but got \(index.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "index", connection: index),
    ...
    return SGScalarError("Unsupported input data types for extract")
}
public func floor(_ in1: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.color3f {
    ...
    return SGVectorError("Unsupported input data types for floor")
}
public func fractal3d(amplitude: SGValue, octaves: SGScalar, lacunarity: SGScalar, diminish: SGScalar, position: SGVector) -> SGValue {
    guard octaves.dataType == SGDataType.int else {
        return SGValueError("Invalid fractal3d input. Expected octaves data type to be SGDataType.int, but got \(octaves.dataType).")
    }
    guard lacunarity.dataType == SGDataType.float else {
        return SGValueError("Invalid fractal3d input. Expected lacunarity data type to be SGDataType.float, but got \(lacunarity.dataType).")
    }
    guard diminish.dataType == SGDataType.float else {
        return SGValueError("Invalid fractal3d input. Expected diminish data type to be SGDataType.float, but got \(diminish.dataType).")
    }
    guard position.dataType == SGDataType.vector3f else {
        return SGValueError("Invalid fractal3d input. Expected position data type to be SGDataType.vector3f, but got \(position.dataType).")
    }
    let inputs: [SGNode.Input] = [
    ...
    return SGVectorError("Unsupported input data types for fractal3d")
}
public func geomcolor(index: SGScalar) -> SGValue {
    guard index.dataType == SGDataType.int else {
        return SGValueError("Invalid geomcolor input. Expected index data type to be SGDataType.int, but got \(index.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "index", connection: index),
    ]
...
public func geompropvalue(geomprop: SGString, defaultValue: SGValue) -> SGValue {
    guard geomprop.dataType == SGDataType.string else {
        return SGValueError("Invalid geompropvalue input. Expected geomprop data type to be SGDataType.string, but got \(geomprop.dataType).")
    }
    let inputs: [SGNode.Input] = [
    ...
    return SGVectorError("Unsupported input data types for geompropvalue")
}
public func heighttonormal(_ in1: SGScalar, scale: SGScalar) -> SGVector {
    guard in1.dataType == SGDataType.float else {
        return SGVectorError("Invalid heighttonormal input. Expected in data type to be SGDataType.float, but got \(in1.dataType).")
    }
    guard scale.dataType == SGDataType.float else {
        return SGVectorError("Invalid heighttonormal input. Expected scale data type to be SGDataType.float, but got \(scale.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "scale", connection: scale),
...
public func hsvadjust(_ in1: SGColor, amount: SGVector) -> SGColor {
    guard amount.dataType == SGDataType.vector3f else {
        return SGColorError("Invalid hsvadjust input. Expected amount data type to be SGDataType.vector3f, but got \(amount.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "amount", connection: amount),
    ...
    return SGColorError("Unsupported input data types for hsvadjust")
}
...
public func ifequal(value1: SGValue, value2: SGValue, in1: SGValue, in2: SGValue) -> SGValue {
    ...
    return SGVectorError("Unsupported input data types for ifequal")
}
public func ifgreater(value1: SGScalar, value2: SGScalar, in1: SGValue, in2: SGValue) -> SGValue {
    ...
    return SGVectorError("Unsupported input data types for ifgreater")
}
...
public func image(file: SGTexture, defaultValue: SGValue, texcoord: SGVector, uaddressmode: SGString, vaddressmode: SGString, filtertype: SGString) -> SGValue {
    ...
    guard uaddressmode.dataType == SGDataType.string else {
        return SGValueError("Invalid image input. Expected uaddressmode data type to be SGDataType.string, but got \(uaddressmode.dataType).")
    }
    guard vaddressmode.dataType == SGDataType.string else {
        return SGValueError("Invalid image input. Expected vaddressmode data type to be SGDataType.string, but got \(vaddressmode.dataType).")
    }
    guard filtertype.dataType == SGDataType.string else {
    ...
    return SGVectorError("Unsupported input data types for image")
}
public func mixColor(fg: SGColor, bg: SGColor, mix: SGScalar) -> SGColor {
    guard fg.dataType == SGDataType.color4f else {
        return SGColorError("Invalid mixColor input. Expected fg data type to be SGDataType.color4f, but got \(fg.dataType).")
    }
    guard bg.dataType == SGDataType.color4f else {
        return SGColorError("Invalid mixColor input. Expected bg data type to be SGDataType.color4f, but got \(bg.dataType).")
    }
    guard mix.dataType == SGDataType.float else {
        return SGColorError("Invalid mixColor input. Expected mix data type to be SGDataType.float, but got \(mix.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
...
public func inside(_ in1: SGValue, mask: SGScalar) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ...
    return SGScalarError("Unsupported input data types for inside")
}
public func invertmatrix(_ in1: SGMatrix) -> SGMatrix {
    ...
    return SGMatrixError("Unsupported input data types for invertmatrix")
}
public func ln(_ in1: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.float {
    ...
    return SGVectorError("Unsupported input data types for ln")
}
public func luminance(_ in1: SGColor, lumacoeffs: SGColor) -> SGColor {
    guard lumacoeffs.dataType == SGDataType.color3f else {
        return SGColorError("Invalid luminance input. Expected lumacoeffs data type to be SGDataType.color3f, but got \(lumacoeffs.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ...
    return SGColorError("Unsupported input data types for luminance")
}
public func magnitude(_ in1: SGVector) -> SGScalar {
    ...
    return SGScalarError("Unsupported input data types for magnitude")
}
public func mask(fg: SGColor, bg: SGColor, mix: SGScalar) -> SGColor {
    guard fg.dataType == SGDataType.color4f else {
        return SGColorError("Invalid mask input. Expected fg data type to be SGDataType.color4f, but got \(fg.dataType).")
    }
    guard bg.dataType == SGDataType.color4f else {
        return SGColorError("Invalid mask input. Expected bg data type to be SGDataType.color4f, but got \(bg.dataType).")
    }
    guard mix.dataType == SGDataType.float else {
        return SGColorError("Invalid mask input. Expected mix data type to be SGDataType.float, but got \(mix.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
...
public func matte(fg: SGColor, bg: SGColor, mix: SGScalar) -> SGColor {
    guard fg.dataType == SGDataType.color4f else {
        return SGColorError("Invalid matte input. Expected fg data type to be SGDataType.color4f, but got \(fg.dataType).")
    }
    guard bg.dataType == SGDataType.color4f else {
        return SGColorError("Invalid matte input. Expected bg data type to be SGDataType.color4f, but got \(bg.dataType).")
    }
    guard mix.dataType == SGDataType.float else {
        return SGColorError("Invalid matte input. Expected mix data type to be SGDataType.float, but got \(mix.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
...
public func max(_ in1: SGValue, _ in2: SGValue) -> SGValue {
    ...
    return SGVectorError("Unsupported input data types for max")
}
public func min(_ in1: SGValue, _ in2: SGValue) -> SGValue {
    ...
    return SGVectorError("Unsupported input data types for min")
}
public func minus(fg: SGValue, bg: SGValue, mix: SGScalar) -> SGValue {
    ...
    return SGScalarError("Unsupported input data types for minus")
}
public func mix(fg: SGValue, bg: SGValue, mix: SGScalar) -> SGValue {
    ...
    return SGVectorError("Unsupported input data types for mix")
}
public func modulo(_ in1: SGValue, _ in2: SGValue) -> SGValue {
    ...
    return SGVectorError("Unsupported input data types for modulo")
}
public func multiply(_ in1: SGValue, _ in2: SGValue) -> SGValue {
    ...
    return SGVectorError("Unsupported input data types for multiply")
}
public func noise2d(amplitude: SGValue, pivot: SGScalar, texcoord: SGVector) -> SGValue {
    guard pivot.dataType == SGDataType.float else {
        return SGValueError("Invalid noise2d input. Expected pivot data type to be SGDataType.float, but got \(pivot.dataType).")
    }
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGValueError("Invalid noise2d input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "amplitude", connection: amplitude),
        .init(name: "pivot", connection: pivot),
    ...
    return SGVectorError("Unsupported input data types for noise2d")
}
public func noise3d(amplitude: SGValue, pivot: SGScalar, position: SGVector) -> SGValue {
    guard pivot.dataType == SGDataType.float else {
        return SGValueError("Invalid noise3d input. Expected pivot data type to be SGDataType.float, but got \(pivot.dataType).")
    }
    guard position.dataType == SGDataType.vector3f else {
        return SGValueError("Invalid noise3d input. Expected position data type to be SGDataType.vector3f, but got \(position.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "amplitude", connection: amplitude),
        .init(name: "pivot", connection: pivot),
...
public func normal(space: SGString) -> SGVector {
    guard space.dataType == SGDataType.string else {
        return SGVectorError("Invalid normal input. Expected space data type to be SGDataType.string, but got \(space.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: space),
    ]
...
public func normalize(_ in1: SGVector) -> SGVector {
    ...
    return SGVectorError("Unsupported input data types for normalize")
}
public func normalmap(_ in1: SGVector, space: SGString, scale: SGValue, normal: SGVector, tangent: SGVector) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
        return SGVectorError("Invalid normalmap input. Expected in data type to be SGDataType.vector3f, but got \(in1.dataType).")
    }
    guard space.dataType == SGDataType.string else {
        return SGVectorError("Invalid normalmap input. Expected space data type to be SGDataType.string, but got \(space.dataType).")
    }
    guard normal.dataType == SGDataType.vector3f else {
        return SGVectorError("Invalid normalmap input. Expected normal data type to be SGDataType.vector3f, but got \(normal.dataType).")
    }
    guard tangent.dataType == SGDataType.vector3f else {
        return SGVectorError("Invalid normalmap input. Expected tangent data type to be SGDataType.vector3f, but got \(tangent.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "space", connection: space),
    ...
    return SGVectorError("Unsupported input data types for normalmap")
}
public func out(fg: SGColor, bg: SGColor, mix: SGScalar) -> SGColor {
    guard fg.dataType == SGDataType.color4f else {
        return SGColorError("Invalid out input. Expected fg data type to be SGDataType.color4f, but got \(fg.dataType).")
    }
    guard bg.dataType == SGDataType.color4f else {
        return SGColorError("Invalid out input. Expected bg data type to be SGDataType.color4f, but got \(bg.dataType).")
    }
    guard mix.dataType == SGDataType.float else {
        return SGColorError("Invalid out input. Expected mix data type to be SGDataType.float, but got \(mix.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
...
public func outside(_ in1: SGValue, mask: SGScalar) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "mask", connection: mask),
    ]
    ...
    return SGScalarError("Unsupported input data types for outside")
}
public func over(fg: SGColor, bg: SGColor, mix: SGScalar) -> SGColor {
    guard fg.dataType == SGDataType.color4f else {
        return SGColorError("Invalid over input. Expected fg data type to be SGDataType.color4f, but got \(fg.dataType).")
    }
    guard bg.dataType == SGDataType.color4f else {
        return SGColorError("Invalid over input. Expected bg data type to be SGDataType.color4f, but got \(bg.dataType).")
    }
    guard mix.dataType == SGDataType.float else {
        return SGColorError("Invalid over input. Expected mix data type to be SGDataType.float, but got \(mix.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
...
public func overlay(fg: SGValue, bg: SGValue, mix: SGScalar) -> SGValue {
    ...
    return SGScalarError("Unsupported input data types for overlay")
}
public func place2d(texcoord: SGVector, pivot: SGVector, scale: SGVector, rotate: SGScalar, offset: SGVector) -> SGVector {
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGVectorError("Invalid place2d input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    guard pivot.dataType == SGDataType.vector2f else {
        return SGVectorError("Invalid place2d input. Expected pivot data type to be SGDataType.vector2f, but got \(pivot.dataType).")
    }
    guard scale.dataType == SGDataType.vector2f else {
        return SGVectorError("Invalid place2d input. Expected scale data type to be SGDataType.vector2f, but got \(scale.dataType).")
    }
    guard rotate.dataType == SGDataType.float else {
        return SGVectorError("Invalid place2d input. Expected rotate data type to be SGDataType.float, but got \(rotate.dataType).")
    }
    guard offset.dataType == SGDataType.vector2f else {
        return SGVectorError("Invalid place2d input. Expected offset data type to be SGDataType.vector2f, but got \(offset.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "texcoord", connection: texcoord),
        .init(name: "pivot", connection: pivot),
...
public func plus(fg: SGValue, bg: SGValue, mix: SGScalar) -> SGValue {
    ...
    return SGScalarError("Unsupported input data types for plus")
}
public func position(space: SGString) -> SGVector {
    guard space.dataType == SGDataType.string else {
        return SGVectorError("Invalid position input. Expected space data type to be SGDataType.string, but got \(space.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: space),
    ]
...
public func power(_ in1: SGValue, _ in2: SGValue) -> SGValue {
    ...
    return SGVectorError("Unsupported input data types for power")
}
public func premult(_ in1: SGColor) -> SGColor {
    guard in1.dataType == SGDataType.color4f else {
        return SGColorError("Invalid premult input. Expected in data type to be SGDataType.color4f, but got \(in1.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
...
public func ramp4(valuetl: SGValue, valuetr: SGValue, valuebl: SGValue, valuebr: SGValue, texcoord: SGVector) -> SGValue {
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGValueError("Invalid ramp4 input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    let inputs: [SGNode.Input] = [
    ...
    return SGVectorError("Unsupported input data types for ramp4")
}
public func ramplr(valuel: SGValue, valuer: SGValue, texcoord: SGVector) -> SGValue {
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGValueError("Invalid ramplr input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    let inputs: [SGNode.Input] = [
    ...
    return SGVectorError("Unsupported input data types for ramplr")
}
public func ramptb(valuet: SGValue, valueb: SGValue, texcoord: SGVector) -> SGValue {
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGValueError("Invalid ramptb input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    let inputs: [SGNode.Input] = [
    ...
    return SGVectorError("Unsupported input data types for ramptb")
}
public func range(_ in1: SGValue, inlow: SGValue, inhigh: SGValue, gamma: SGValue, outlow: SGValue, outhigh: SGValue, doclamp: SGValue) -> SGValue {
    guard doclamp.dataType == SGDataType.bool else {
        return SGValueError("Invalid range input. Expected doclamp data type to be SGDataType.bool, but got \(doclamp.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ...
    return SGVectorError("Unsupported input data types for range")
}
public func cameraposition(space: SGString) -> SGVector {
    guard space.dataType == SGDataType.string else {
        return SGVectorError("Invalid cameraposition input. Expected space data type to be SGDataType.string, but got \(space.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: space),
    ]
...
public func cubeimage(file: SGTexture, defaultValue: SGValue, texcoord: SGVector, filtertype: SGString) -> SGValue {
    guard file.dataType == SGDataType.asset else {
        return SGValueError("Invalid cubeimage input. Expected file data type to be SGDataType.asset, but got \(file.dataType).")
    }
    guard texcoord.dataType == SGDataType.vector3f else {
        return SGValueError("Invalid cubeimage input. Expected texcoord data type to be SGDataType.vector3f, but got \(texcoord.dataType).")
    }
    guard filtertype.dataType == SGDataType.string else {
        return SGValueError("Invalid cubeimage input. Expected filtertype data type to be SGDataType.string, but got \(filtertype.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "file", connection: file),
        .init(name: "default", connection: defaultValue),
    ...
    return SGVectorError("Unsupported input data types for cubeimage")
}
public func fractional(_ in1: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.color3f {
...
public func image_bias(file: SGTexture, defaultValue: SGValue, texcoord: SGVector, bias: SGScalar, coord: SGString, s_address: SGString, t_address: SGString, border_color: SGString, mag_filter: SGString, min_filter: SGString, mip_filter: SGString, max_anisotropy: SGScalar, lod_min: SGScalar, lod_max: SGScalar) -> SGValue {
    guard file.dataType == SGDataType.asset else {
        return SGValueError("Invalid image_bias input. Expected file data type to be SGDataType.asset, but got \(file.dataType).")
    }
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGValueError("Invalid image_bias input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    guard bias.dataType == SGDataType.float else {
        return SGValueError("Invalid image_bias input. Expected bias data type to be SGDataType.float, but got \(bias.dataType).")
    }
    guard coord.dataType == SGDataType.string else {
        return SGValueError("Invalid image_bias input. Expected coord data type to be SGDataType.string, but got \(coord.dataType).")
    }
    guard s_address.dataType == SGDataType.string else {
        return SGValueError("Invalid image_bias input. Expected s_address data type to be SGDataType.string, but got \(s_address.dataType).")
    }
    guard t_address.dataType == SGDataType.string else {
        return SGValueError("Invalid image_bias input. Expected t_address data type to be SGDataType.string, but got \(t_address.dataType).")
    }
    guard border_color.dataType == SGDataType.string else {
        return SGValueError("Invalid image_bias input. Expected border_color data type to be SGDataType.string, but got \(border_color.dataType).")
    }
    guard mag_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image_bias input. Expected mag_filter data type to be SGDataType.string, but got \(mag_filter.dataType).")
    }
    guard min_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image_bias input. Expected min_filter data type to be SGDataType.string, but got \(min_filter.dataType).")
    }
    guard mip_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image_bias input. Expected mip_filter data type to be SGDataType.string, but got \(mip_filter.dataType).")
    }
    guard max_anisotropy.dataType == SGDataType.int else {
        return SGValueError("Invalid image_bias input. Expected max_anisotropy data type to be SGDataType.int, but got \(max_anisotropy.dataType).")
    }
    guard lod_min.dataType == SGDataType.float else {
        return SGValueError("Invalid image_bias input. Expected lod_min data type to be SGDataType.float, but got \(lod_min.dataType).")
    }
    guard lod_max.dataType == SGDataType.float else {
        return SGValueError("Invalid image_bias input. Expected lod_max data type to be SGDataType.float, but got \(lod_max.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "file", connection: file),
        .init(name: "default", connection: defaultValue),
    ...
    if defaultValue.dataType == SGDataType.vector2h {
        return SGVector(source: .nodeOutput(SGNode(
            nodeType: "ND_realitykit_image_bias_half2",
            inputs: inputs,
            outputs: [.init(dataType: SGDataType.vector2h)])))
    }
    if defaultValue.dataType == SGDataType.vector3h {
        return SGVector(source: .nodeOutput(SGNode(
    ...
    return SGVectorError("Unsupported input data types for image_bias")
}
public func image_bias_min_lod_clamp(file: SGTexture, defaultValue: SGValue, texcoord: SGVector, bias: SGScalar, min_lod_clamp: SGScalar, coord: SGString, s_address: SGString, t_address: SGString, border_color: SGString, mag_filter: SGString, min_filter: SGString, mip_filter: SGString, max_anisotropy: SGScalar, lod_min: SGScalar, lod_max: SGScalar) -> SGValue {
    guard file.dataType == SGDataType.asset else {
        return SGValueError("Invalid image_bias_min_lod_clamp input. Expected file data type to be SGDataType.asset, but got \(file.dataType).")
    }
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGValueError("Invalid image_bias_min_lod_clamp input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    guard bias.dataType == SGDataType.float else {
        return SGValueError("Invalid image_bias_min_lod_clamp input. Expected bias data type to be SGDataType.float, but got \(bias.dataType).")
    }
    guard min_lod_clamp.dataType == SGDataType.float else {
        return SGValueError("Invalid image_bias_min_lod_clamp input. Expected min_lod_clamp data type to be SGDataType.float, but got \(min_lod_clamp.dataType).")
    }
    guard coord.dataType == SGDataType.string else {
        return SGValueError("Invalid image_bias_min_lod_clamp input. Expected coord data type to be SGDataType.string, but got \(coord.dataType).")
    }
    guard s_address.dataType == SGDataType.string else {
        return SGValueError("Invalid image_bias_min_lod_clamp input. Expected s_address data type to be SGDataType.string, but got \(s_address.dataType).")
    }
    guard t_address.dataType == SGDataType.string else {
        return SGValueError("Invalid image_bias_min_lod_clamp input. Expected t_address data type to be SGDataType.string, but got \(t_address.dataType).")
    }
    guard border_color.dataType == SGDataType.string else {
        return SGValueError("Invalid image_bias_min_lod_clamp input. Expected border_color data type to be SGDataType.string, but got \(border_color.dataType).")
    }
    guard mag_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image_bias_min_lod_clamp input. Expected mag_filter data type to be SGDataType.string, but got \(mag_filter.dataType).")
    }
    guard min_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image_bias_min_lod_clamp input. Expected min_filter data type to be SGDataType.string, but got \(min_filter.dataType).")
    }
    guard mip_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image_bias_min_lod_clamp input. Expected mip_filter data type to be SGDataType.string, but got \(mip_filter.dataType).")
    }
    guard max_anisotropy.dataType == SGDataType.int else {
        return SGValueError("Invalid image_bias_min_lod_clamp input. Expected max_anisotropy data type to be SGDataType.int, but got \(max_anisotropy.dataType).")
    }
    guard lod_min.dataType == SGDataType.float else {
        return SGValueError("Invalid image_bias_min_lod_clamp input. Expected lod_min data type to be SGDataType.float, but got \(lod_min.dataType).")
    }
    guard lod_max.dataType == SGDataType.float else {
        return SGValueError("Invalid image_bias_min_lod_clamp input. Expected lod_max data type to be SGDataType.float, but got \(lod_max.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "file", connection: file),
        .init(name: "default", connection: defaultValue),
    ...
    return SGVectorError("Unsupported input data types for image_bias_min_lod_clamp")
}
public func image(file: SGTexture, defaultValue: SGValue, texcoord: SGVector, coord: SGString, s_address: SGString, t_address: SGString, border_color: SGString, mag_filter: SGString, min_filter: SGString, mip_filter: SGString, max_anisotropy: SGScalar, lod_min: SGScalar, lod_max: SGScalar) -> SGValue {
    guard file.dataType == SGDataType.asset else {
        return SGValueError("Invalid image input. Expected file data type to be SGDataType.asset, but got \(file.dataType).")
    }
    guard texcoord.dataType == SGDataType.vector2f else {
    ...
    guard coord.dataType == SGDataType.string else {
        return SGValueError("Invalid image input. Expected coord data type to be SGDataType.string, but got \(coord.dataType).")
    }
    guard s_address.dataType == SGDataType.string else {
        return SGValueError("Invalid image input. Expected s_address data type to be SGDataType.string, but got \(s_address.dataType).")
    }
    guard t_address.dataType == SGDataType.string else {
        return SGValueError("Invalid image input. Expected t_address data type to be SGDataType.string, but got \(t_address.dataType).")
    }
    guard border_color.dataType == SGDataType.string else {
        return SGValueError("Invalid image input. Expected border_color data type to be SGDataType.string, but got \(border_color.dataType).")
    }
    guard mag_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image input. Expected mag_filter data type to be SGDataType.string, but got \(mag_filter.dataType).")
    }
    guard min_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image input. Expected min_filter data type to be SGDataType.string, but got \(min_filter.dataType).")
    }
    guard mip_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image input. Expected mip_filter data type to be SGDataType.string, but got \(mip_filter.dataType).")
    }
    guard max_anisotropy.dataType == SGDataType.int else {
        return SGValueError("Invalid image input. Expected max_anisotropy data type to be SGDataType.int, but got \(max_anisotropy.dataType).")
    }
    guard lod_min.dataType == SGDataType.float else {
        return SGValueError("Invalid image input. Expected lod_min data type to be SGDataType.float, but got \(lod_min.dataType).")
    }
    guard lod_max.dataType == SGDataType.float else {
        return SGValueError("Invalid image input. Expected lod_max data type to be SGDataType.float, but got \(lod_max.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "file", connection: file),
        .init(name: "default", connection: defaultValue),
...
public func image_gradient2d(file: SGTexture, defaultValue: SGValue, texcoord: SGVector, gradient2d_x: SGString, gradient2d_y: SGString, coord: SGString, s_address: SGString, t_address: SGString, border_color: SGString, mag_filter: SGString, min_filter: SGString, mip_filter: SGString, max_anisotropy: SGScalar, lod_min: SGScalar, lod_max: SGScalar) -> SGValue {
    guard file.dataType == SGDataType.asset else {
        return SGValueError("Invalid image_gradient2d input. Expected file data type to be SGDataType.asset, but got \(file.dataType).")
    }
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGValueError("Invalid image_gradient2d input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    guard gradient2d_x.dataType == SGDataType.string else {
        return SGValueError("Invalid image_gradient2d input. Expected gradient2d_x data type to be SGDataType.string, but got \(gradient2d_x.dataType).")
    }
    guard gradient2d_y.dataType == SGDataType.string else {
        return SGValueError("Invalid image_gradient2d input. Expected gradient2d_y data type to be SGDataType.string, but got \(gradient2d_y.dataType).")
    }
    guard coord.dataType == SGDataType.string else {
        return SGValueError("Invalid image_gradient2d input. Expected coord data type to be SGDataType.string, but got \(coord.dataType).")
    }
    guard s_address.dataType == SGDataType.string else {
        return SGValueError("Invalid image_gradient2d input. Expected s_address data type to be SGDataType.string, but got \(s_address.dataType).")
    }
    guard t_address.dataType == SGDataType.string else {
        return SGValueError("Invalid image_gradient2d input. Expected t_address data type to be SGDataType.string, but got \(t_address.dataType).")
    }
    guard border_color.dataType == SGDataType.string else {
        return SGValueError("Invalid image_gradient2d input. Expected border_color data type to be SGDataType.string, but got \(border_color.dataType).")
    }
    guard mag_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image_gradient2d input. Expected mag_filter data type to be SGDataType.string, but got \(mag_filter.dataType).")
    }
    guard min_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image_gradient2d input. Expected min_filter data type to be SGDataType.string, but got \(min_filter.dataType).")
    }
    guard mip_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image_gradient2d input. Expected mip_filter data type to be SGDataType.string, but got \(mip_filter.dataType).")
    }
    guard max_anisotropy.dataType == SGDataType.int else {
        return SGValueError("Invalid image_gradient2d input. Expected max_anisotropy data type to be SGDataType.int, but got \(max_anisotropy.dataType).")
    }
    guard lod_min.dataType == SGDataType.float else {
        return SGValueError("Invalid image_gradient2d input. Expected lod_min data type to be SGDataType.float, but got \(lod_min.dataType).")
    }
    guard lod_max.dataType == SGDataType.float else {
        return SGValueError("Invalid image_gradient2d input. Expected lod_max data type to be SGDataType.float, but got \(lod_max.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "file", connection: file),
        .init(name: "default", connection: defaultValue),
    ...
    return SGVectorError("Unsupported input data types for image_gradient2d")
}
public func image_gradient2d_min_lod_clamp(file: SGTexture, defaultValue: SGValue, texcoord: SGVector, gradient2d_x: SGString, gradient2d_y: SGString, min_lod_clamp: SGScalar, coord: SGString, s_address: SGString, t_address: SGString, border_color: SGString, mag_filter: SGString, min_filter: SGString, mip_filter: SGString, max_anisotropy: SGScalar, lod_min: SGScalar, lod_max: SGScalar) -> SGValue {
    guard file.dataType == SGDataType.asset else {
        return SGValueError("Invalid image_gradient2d_min_lod_clamp input. Expected file data type to be SGDataType.asset, but got \(file.dataType).")
    }
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGValueError("Invalid image_gradient2d_min_lod_clamp input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    guard gradient2d_x.dataType == SGDataType.string else {
        return SGValueError("Invalid image_gradient2d_min_lod_clamp input. Expected gradient2d_x data type to be SGDataType.string, but got \(gradient2d_x.dataType).")
    }
    guard gradient2d_y.dataType == SGDataType.string else {
        return SGValueError("Invalid image_gradient2d_min_lod_clamp input. Expected gradient2d_y data type to be SGDataType.string, but got \(gradient2d_y.dataType).")
    }
    guard min_lod_clamp.dataType == SGDataType.float else {
        return SGValueError("Invalid image_gradient2d_min_lod_clamp input. Expected min_lod_clamp data type to be SGDataType.float, but got \(min_lod_clamp.dataType).")
    }
    guard coord.dataType == SGDataType.string else {
        return SGValueError("Invalid image_gradient2d_min_lod_clamp input. Expected coord data type to be SGDataType.string, but got \(coord.dataType).")
    }
    guard s_address.dataType == SGDataType.string else {
        return SGValueError("Invalid image_gradient2d_min_lod_clamp input. Expected s_address data type to be SGDataType.string, but got \(s_address.dataType).")
    }
    guard t_address.dataType == SGDataType.string else {
        return SGValueError("Invalid image_gradient2d_min_lod_clamp input. Expected t_address data type to be SGDataType.string, but got \(t_address.dataType).")
    }
    guard border_color.dataType == SGDataType.string else {
        return SGValueError("Invalid image_gradient2d_min_lod_clamp input. Expected border_color data type to be SGDataType.string, but got \(border_color.dataType).")
    }
    guard mag_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image_gradient2d_min_lod_clamp input. Expected mag_filter data type to be SGDataType.string, but got \(mag_filter.dataType).")
    }
    guard min_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image_gradient2d_min_lod_clamp input. Expected min_filter data type to be SGDataType.string, but got \(min_filter.dataType).")
    }
    guard mip_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image_gradient2d_min_lod_clamp input. Expected mip_filter data type to be SGDataType.string, but got \(mip_filter.dataType).")
    }
    guard max_anisotropy.dataType == SGDataType.int else {
        return SGValueError("Invalid image_gradient2d_min_lod_clamp input. Expected max_anisotropy data type to be SGDataType.int, but got \(max_anisotropy.dataType).")
    }
    guard lod_min.dataType == SGDataType.float else {
        return SGValueError("Invalid image_gradient2d_min_lod_clamp input. Expected lod_min data type to be SGDataType.float, but got \(lod_min.dataType).")
    }
    guard lod_max.dataType == SGDataType.float else {
        return SGValueError("Invalid image_gradient2d_min_lod_clamp input. Expected lod_max data type to be SGDataType.float, but got \(lod_max.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "file", connection: file),
        .init(name: "default", connection: defaultValue),
    ...
    return SGVectorError("Unsupported input data types for image_gradient2d_min_lod_clamp")
}
public func image_lod(file: SGTexture, defaultValue: SGValue, texcoord: SGVector, level: SGScalar, coord: SGString, s_address: SGString, t_address: SGString, border_color: SGString, mag_filter: SGString, min_filter: SGString, mip_filter: SGString, max_anisotropy: SGScalar, lod_min: SGScalar, lod_max: SGScalar) -> SGValue {
    guard file.dataType == SGDataType.asset else {
        return SGValueError("Invalid image_lod input. Expected file data type to be SGDataType.asset, but got \(file.dataType).")
    }
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGValueError("Invalid image_lod input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    guard level.dataType == SGDataType.float else {
        return SGValueError("Invalid image_lod input. Expected level data type to be SGDataType.float, but got \(level.dataType).")
    }
    guard coord.dataType == SGDataType.string else {
        return SGValueError("Invalid image_lod input. Expected coord data type to be SGDataType.string, but got \(coord.dataType).")
    }
    guard s_address.dataType == SGDataType.string else {
        return SGValueError("Invalid image_lod input. Expected s_address data type to be SGDataType.string, but got \(s_address.dataType).")
    }
    guard t_address.dataType == SGDataType.string else {
        return SGValueError("Invalid image_lod input. Expected t_address data type to be SGDataType.string, but got \(t_address.dataType).")
    }
    guard border_color.dataType == SGDataType.string else {
        return SGValueError("Invalid image_lod input. Expected border_color data type to be SGDataType.string, but got \(border_color.dataType).")
    }
    guard mag_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image_lod input. Expected mag_filter data type to be SGDataType.string, but got \(mag_filter.dataType).")
    }
    guard min_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image_lod input. Expected min_filter data type to be SGDataType.string, but got \(min_filter.dataType).")
    }
    guard mip_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image_lod input. Expected mip_filter data type to be SGDataType.string, but got \(mip_filter.dataType).")
    }
    guard max_anisotropy.dataType == SGDataType.int else {
        return SGValueError("Invalid image_lod input. Expected max_anisotropy data type to be SGDataType.int, but got \(max_anisotropy.dataType).")
    }
    guard lod_min.dataType == SGDataType.float else {
        return SGValueError("Invalid image_lod input. Expected lod_min data type to be SGDataType.float, but got \(lod_min.dataType).")
    }
    guard lod_max.dataType == SGDataType.float else {
        return SGValueError("Invalid image_lod input. Expected lod_max data type to be SGDataType.float, but got \(lod_max.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "file", connection: file),
        .init(name: "default", connection: defaultValue),
    ...
    return SGVectorError("Unsupported input data types for image_lod")
}
public func image_min_lod_clamp(file: SGTexture, defaultValue: SGValue, texcoord: SGVector, min_lod_clamp: SGScalar, coord: SGString, s_address: SGString, t_address: SGString, border_color: SGString, mag_filter: SGString, min_filter: SGString, mip_filter: SGString, max_anisotropy: SGScalar, lod_min: SGScalar, lod_max: SGScalar) -> SGValue {
    guard file.dataType == SGDataType.asset else {
        return SGValueError("Invalid image_min_lod_clamp input. Expected file data type to be SGDataType.asset, but got \(file.dataType).")
    }
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGValueError("Invalid image_min_lod_clamp input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    guard min_lod_clamp.dataType == SGDataType.float else {
        return SGValueError("Invalid image_min_lod_clamp input. Expected min_lod_clamp data type to be SGDataType.float, but got \(min_lod_clamp.dataType).")
    }
    guard coord.dataType == SGDataType.string else {
        return SGValueError("Invalid image_min_lod_clamp input. Expected coord data type to be SGDataType.string, but got \(coord.dataType).")
    }
    guard s_address.dataType == SGDataType.string else {
        return SGValueError("Invalid image_min_lod_clamp input. Expected s_address data type to be SGDataType.string, but got \(s_address.dataType).")
    }
    guard t_address.dataType == SGDataType.string else {
        return SGValueError("Invalid image_min_lod_clamp input. Expected t_address data type to be SGDataType.string, but got \(t_address.dataType).")
    }
    guard border_color.dataType == SGDataType.string else {
        return SGValueError("Invalid image_min_lod_clamp input. Expected border_color data type to be SGDataType.string, but got \(border_color.dataType).")
    }
    guard mag_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image_min_lod_clamp input. Expected mag_filter data type to be SGDataType.string, but got \(mag_filter.dataType).")
    }
    guard min_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image_min_lod_clamp input. Expected min_filter data type to be SGDataType.string, but got \(min_filter.dataType).")
    }
    guard mip_filter.dataType == SGDataType.string else {
        return SGValueError("Invalid image_min_lod_clamp input. Expected mip_filter data type to be SGDataType.string, but got \(mip_filter.dataType).")
    }
    guard max_anisotropy.dataType == SGDataType.int else {
        return SGValueError("Invalid image_min_lod_clamp input. Expected max_anisotropy data type to be SGDataType.int, but got \(max_anisotropy.dataType).")
    }
    guard lod_min.dataType == SGDataType.float else {
        return SGValueError("Invalid image_min_lod_clamp input. Expected lod_min data type to be SGDataType.float, but got \(lod_min.dataType).")
    }
    guard lod_max.dataType == SGDataType.float else {
        return SGValueError("Invalid image_min_lod_clamp input. Expected lod_max data type to be SGDataType.float, but got \(lod_max.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "file", connection: file),
        .init(name: "default", connection: defaultValue),
    ...
    return SGVectorError("Unsupported input data types for image_min_lod_clamp")
}
...
public func oneminus(_ in1: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.color3f {
    ...
    return SGVectorError("Unsupported input data types for oneminus")
}
public func reflect(_ in1: SGVector, normal: SGVector) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
        return SGVectorError("Invalid reflect input. Expected in data type to be SGDataType.vector3f, but got \(in1.dataType).")
    }
    guard normal.dataType == SGDataType.vector3f else {
        return SGVectorError("Invalid reflect input. Expected normal data type to be SGDataType.vector3f, but got \(normal.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "normal", connection: normal),
...
public func refract(_ in1: SGVector, normal: SGVector, eta: SGScalar) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
        return SGVectorError("Invalid refract input. Expected in data type to be SGDataType.vector3f, but got \(in1.dataType).")
    }
    guard normal.dataType == SGDataType.vector3f else {
        return SGVectorError("Invalid refract input. Expected normal data type to be SGDataType.vector3f, but got \(normal.dataType).")
    }
    guard eta.dataType == SGDataType.float else {
        return SGVectorError("Invalid refract input. Expected eta data type to be SGDataType.float, but got \(eta.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "normal", connection: normal),
...
public func step(_ in1: SGValue, edge: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ...
    return SGVectorError("Unsupported input data types for step")
}
public func viewdirection(space: SGString) -> SGVector {
    guard space.dataType == SGDataType.string else {
        return SGVectorError("Invalid viewdirection input. Expected space data type to be SGDataType.string, but got \(space.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: space),
    ]
...
public func remap(_ in1: SGValue, inlow: SGValue, inhigh: SGValue, outlow: SGValue, outhigh: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "inlow", connection: inlow),
        .init(name: "inhigh", connection: inhigh),
    ...
    return SGVectorError("Unsupported input data types for remap")
}
public func rgbtohsv(_ in1: SGColor) -> SGColor {
    ...
    return SGColorError("Unsupported input data types for rgbtohsv")
}
public func rotate2d(_ in1: SGVector, amount: SGScalar) -> SGVector {
    guard in1.dataType == SGDataType.vector2f else {
        return SGVectorError("Invalid rotate2d input. Expected in data type to be SGDataType.vector2f, but got \(in1.dataType).")
    }
    guard amount.dataType == SGDataType.float else {
        return SGVectorError("Invalid rotate2d input. Expected amount data type to be SGDataType.float, but got \(amount.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "amount", connection: amount),
...
public func rotate3d(_ in1: SGVector, amount: SGScalar, axis: SGVector) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
        return SGVectorError("Invalid rotate3d input. Expected in data type to be SGDataType.vector3f, but got \(in1.dataType).")
    }
    guard amount.dataType == SGDataType.float else {
        return SGVectorError("Invalid rotate3d input. Expected amount data type to be SGDataType.float, but got \(amount.dataType).")
    }
    guard axis.dataType == SGDataType.vector3f else {
        return SGVectorError("Invalid rotate3d input. Expected axis data type to be SGDataType.vector3f, but got \(axis.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "amount", connection: amount),
...
public func round(_ in1: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.color3f {
    ...
    return SGVectorError("Unsupported input data types for round")
}
public func safepower(_ in1: SGValue, _ in2: SGValue) -> SGValue {
    ...
    return SGVectorError("Unsupported input data types for safepower")
}
public func saturate(_ in1: SGColor, amount: SGScalar, lumacoeffs: SGColor) -> SGColor {
    guard amount.dataType == SGDataType.float else {
        return SGColorError("Invalid saturate input. Expected amount data type to be SGDataType.float, but got \(amount.dataType).")
    }
    guard lumacoeffs.dataType == SGDataType.color3f else {
        return SGColorError("Invalid saturate input. Expected lumacoeffs data type to be SGDataType.color3f, but got \(lumacoeffs.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "amount", connection: amount),
    ...
    return SGColorError("Unsupported input data types for saturate")
}
public func screen(fg: SGValue, bg: SGValue, mix: SGScalar) -> SGValue {
    ...
    return SGScalarError("Unsupported input data types for screen")
}
public func sign(_ in1: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.color3f {
    ...
    return SGVectorError("Unsupported input data types for sign")
}
public func sin(_ in1: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.float {
    ...
    return SGVectorError("Unsupported input data types for sin")
}
public func smoothstep(_ in1: SGValue, low: SGValue, high: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "low", connection: low),
        .init(name: "high", connection: high),
    ...
    return SGVectorError("Unsupported input data types for smoothstep")
}
public func splitlr(valuel: SGValue, valuer: SGValue, center: SGScalar, texcoord: SGVector) -> SGValue {
    guard center.dataType == SGDataType.float else {
        return SGValueError("Invalid splitlr input. Expected center data type to be SGDataType.float, but got \(center.dataType).")
    }
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGValueError("Invalid splitlr input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "valuel", connection: valuel),
        .init(name: "valuer", connection: valuer),
    ...
    return SGVectorError("Unsupported input data types for splitlr")
}
public func splittb(valuet: SGValue, valueb: SGValue, center: SGScalar, texcoord: SGVector) -> SGValue {
    guard center.dataType == SGDataType.float else {
        return SGValueError("Invalid splittb input. Expected center data type to be SGDataType.float, but got \(center.dataType).")
    }
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGValueError("Invalid splittb input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "valuet", connection: valuet),
        .init(name: "valueb", connection: valueb),
    ...
    return SGVectorError("Unsupported input data types for splittb")
}
public func sqrt(_ in1: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.float {
    ...
    return SGVectorError("Unsupported input data types for sqrt")
}
public func subtract(_ in1: SGValue, _ in2: SGValue) -> SGValue {
    ...
    return SGVectorError("Unsupported input data types for subtract")
}
public func switchValue(_ in1: SGValue, _ in2: SGValue, _ in3: SGValue, _ in4: SGValue, _ in5: SGValue, _ in6: SGValue, _ in7: SGValue, _ in8: SGValue, _ in9: SGValue, _ in10: SGValue, which: SGScalar) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in1", connection: in1),
        .init(name: "in2", connection: in2),
    ...
    return SGVectorError("Unsupported input data types for switchValue")
}
public func tan(_ in1: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.float {
    ...
    return SGVectorError("Unsupported input data types for tan")
}
public func tangent(space: SGString, index: SGScalar) -> SGVector {
    guard space.dataType == SGDataType.string else {
        return SGVectorError("Invalid tangent input. Expected space data type to be SGDataType.string, but got \(space.dataType).")
    }
    guard index.dataType == SGDataType.int else {
        return SGVectorError("Invalid tangent input. Expected index data type to be SGDataType.int, but got \(index.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: space),
        .init(name: "index", connection: index),
...
public func texcoord(index: SGScalar) -> SGVector {
    guard index.dataType == SGDataType.int else {
        return SGVectorError("Invalid texcoord input. Expected index data type to be SGDataType.int, but got \(index.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "index", connection: index),
    ]
...
public func tiledimage(file: SGTexture, defaultValue: SGValue, texcoord: SGVector, uvtiling: SGVector, uvoffset: SGVector, realworldimagesize: SGVector, realworldtilesize: SGVector, filtertype: SGString) -> SGValue {
    ...
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGValueError("Invalid tiledimage input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    guard uvtiling.dataType == SGDataType.vector2f else {
        return SGValueError("Invalid tiledimage input. Expected uvtiling data type to be SGDataType.vector2f, but got \(uvtiling.dataType).")
    }
    guard uvoffset.dataType == SGDataType.vector2f else {
        return SGValueError("Invalid tiledimage input. Expected uvoffset data type to be SGDataType.vector2f, but got \(uvoffset.dataType).")
    }
    guard realworldimagesize.dataType == SGDataType.vector2f else {
        return SGValueError("Invalid tiledimage input. Expected realworldimagesize data type to be SGDataType.vector2f, but got \(realworldimagesize.dataType).")
    }
    guard realworldtilesize.dataType == SGDataType.vector2f else {
        return SGValueError("Invalid tiledimage input. Expected realworldtilesize data type to be SGDataType.vector2f, but got \(realworldtilesize.dataType).")
    }
    guard filtertype.dataType == SGDataType.string else {
...
public func transformnormal(_ in1: SGVector, fromspace: SGString, tospace: SGString) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
        return SGVectorError("Invalid transformnormal input. Expected in data type to be SGDataType.vector3f, but got \(in1.dataType).")
    }
    guard fromspace.dataType == SGDataType.string else {
        return SGVectorError("Invalid transformnormal input. Expected fromspace data type to be SGDataType.string, but got \(fromspace.dataType).")
    }
    guard tospace.dataType == SGDataType.string else {
        return SGVectorError("Invalid transformnormal input. Expected tospace data type to be SGDataType.string, but got \(tospace.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
...
public func transformpoint(_ in1: SGVector, fromspace: SGString, tospace: SGString) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
        return SGVectorError("Invalid transformpoint input. Expected in data type to be SGDataType.vector3f, but got \(in1.dataType).")
    }
    guard fromspace.dataType == SGDataType.string else {
        return SGVectorError("Invalid transformpoint input. Expected fromspace data type to be SGDataType.string, but got \(fromspace.dataType).")
    }
    guard tospace.dataType == SGDataType.string else {
        return SGVectorError("Invalid transformpoint input. Expected tospace data type to be SGDataType.string, but got \(tospace.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "fromspace", connection: fromspace),
...
public func transformvector(_ in1: SGVector, fromspace: SGString, tospace: SGString) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
        return SGVectorError("Invalid transformvector input. Expected in data type to be SGDataType.vector3f, but got \(in1.dataType).")
    }
    guard fromspace.dataType == SGDataType.string else {
        return SGVectorError("Invalid transformvector input. Expected fromspace data type to be SGDataType.string, but got \(fromspace.dataType).")
    }
    guard tospace.dataType == SGDataType.string else {
        return SGVectorError("Invalid transformvector input. Expected tospace data type to be SGDataType.string, but got \(tospace.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "fromspace", connection: fromspace),
...
public func triplanarprojection(filex: SGTexture, filey: SGTexture, filez: SGTexture, defaultValue: SGValue, position: SGVector, normal: SGVector, filtertype: SGString) -> SGValue {
    ...
    guard filey.dataType == SGDataType.asset else {
        return SGValueError("Invalid triplanarprojection input. Expected filey data type to be SGDataType.asset, but got \(filey.dataType).")
    }
    ...
    guard normal.dataType == SGDataType.vector3f else {
        return SGValueError("Invalid triplanarprojection input. Expected normal data type to be SGDataType.vector3f, but got \(normal.dataType).")
    }
    guard filtertype.dataType == SGDataType.string else {
    ...
    return SGVectorError("Unsupported input data types for triplanarprojection")
}
public func unpremult(_ in1: SGColor) -> SGColor {
    guard in1.dataType == SGDataType.color4f else {
        return SGColorError("Invalid unpremult input. Expected in data type to be SGDataType.color4f, but got \(in1.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
...
public func updirection(space: SGString) -> SGVector {
    guard space.dataType == SGDataType.string else {
        return SGVectorError("Invalid updirection input. Expected space data type to be SGDataType.string, but got \(space.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: space),
    ]
...
public func worleynoise2d(texcoord: SGVector, jitter: SGScalar) -> SGValue {
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGValueError("Invalid worleynoise2d input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    guard jitter.dataType == SGDataType.float else {
        return SGValueError("Invalid worleynoise2d input. Expected jitter data type to be SGDataType.float, but got \(jitter.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "texcoord", connection: texcoord),
...
public func worleynoise3d(position: SGVector, jitter: SGScalar) -> SGValue {
    guard position.dataType == SGDataType.vector3f else {
        return SGValueError("Invalid worleynoise3d input. Expected position data type to be SGDataType.vector3f, but got \(position.dataType).")
    }
    guard jitter.dataType == SGDataType.float else {
        return SGValueError("Invalid worleynoise3d input. Expected jitter data type to be SGDataType.float, but got \(jitter.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "position", connection: position),
        .init(name: "jitter", connection: jitter),
