...
import Foundation
/// Abs
public func absval(_ in1: SGNumeric) -> SGNumeric {
...
/// Acos
public func acos(_ in1: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.float {
...
/// Add
public func add(_ in1: SGNumeric, _ in2: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
...
/// Asin
public func asin(_ in1: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.float {
...
/// Atan2
public func atan2(iny: SGNumeric, inx: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
...
/// Blur
public func blur(_ in1: SGNumeric, size: SGScalar, filtertype: SGString) -> SGNumeric {
    guard filtertype.dataType == SGDataType.string else {
        return SGNumericError("Invalid blur input. Expected filtertype data type to be SGDataType.string, but got \(filtertype.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
...
/// Burn
public func burn(fg: SGNumeric, bg: SGNumeric, mix: SGScalar) -> SGNumeric {
    let inputs: [SGNode.Input] = [
...
/// Ceiling
public func ceil(_ in1: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.color3f {
...
/// Clamp
public func clamp(_ in1: SGNumeric, low: SGNumeric, high: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
...
/// Contrast
public func contrast(_ in1: SGNumeric, amount: SGNumeric, pivot: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
...
/// Cos
public func cos(_ in1: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.float {
...
/// Difference
public func difference(fg: SGNumeric, bg: SGNumeric, mix: SGScalar) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
        .init(name: "mix", connection: mix),
...
/// Divide
public func divide(_ in1: SGNumeric, _ in2: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in1", connection: in1),
        .init(name: "in2", connection: in2),
    ]
...
/// Dodge
public func dodge(fg: SGNumeric, bg: SGNumeric, mix: SGScalar) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
        .init(name: "mix", connection: mix),
...
/// Exp
public func exp(_ in1: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.float {
...
/// Floor
public func floor(_ in1: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.color3f {
...
/// Fractal Noise 3D
public func fractal3d(amplitude: SGNumeric, octaves: SGScalar, lacunarity: SGScalar, diminish: SGScalar, position: SGVector) -> SGNumeric {
    guard octaves.dataType == SGDataType.int else {
        return SGNumericError("Invalid fractal3d input. Expected octaves data type to be SGDataType.int, but got \(octaves.dataType).")
    }
    guard lacunarity.dataType == SGDataType.float else {
        return SGNumericError("Invalid fractal3d input. Expected lacunarity data type to be SGDataType.float, but got \(lacunarity.dataType).")
    }
    guard diminish.dataType == SGDataType.float else {
        return SGNumericError("Invalid fractal3d input. Expected diminish data type to be SGDataType.float, but got \(diminish.dataType).")
    }
    guard position.dataType == SGDataType.vector3f else {
        return SGNumericError("Invalid fractal3d input. Expected position data type to be SGDataType.vector3f, but got \(position.dataType).")
    }
    let inputs: [SGNode.Input] = [
...
public func geomcolor(index: SGScalar) -> SGNumeric {
    guard index.dataType == SGDataType.int else {
        return SGNumericError("Invalid geomcolor input. Expected index data type to be SGDataType.int, but got \(index.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "index", connection: index),
    ]
...
/// If Greater
public func ifgreater(value1: SGScalar, value2: SGScalar, in1: SGNumeric, in2: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "value1", connection: value1),
        .init(name: "value2", connection: value2),
        .init(name: "in1", connection: in1),
...
/// If Greater Or Equal
public func ifgreatereq(value1: SGScalar, value2: SGScalar, in1: SGNumeric, in2: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "value1", connection: value1),
        .init(name: "value2", connection: value2),
        .init(name: "in1", connection: in1),
...
/// Image
public func image(file: SGTexture, defaultValue: SGNumeric, texcoord: SGVector, uaddressmode: SGString, vaddressmode: SGString, filtertype: SGString) -> SGNumeric {
    guard file.dataType == SGDataType.asset else {
        return SGNumericError("Invalid image input. Expected file data type to be SGDataType.asset, but got \(file.dataType).")
    }
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGNumericError("Invalid image input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    guard uaddressmode.dataType == SGDataType.string else {
        return SGNumericError("Invalid image input. Expected uaddressmode data type to be SGDataType.string, but got \(uaddressmode.dataType).")
    }
    guard vaddressmode.dataType == SGDataType.string else {
        return SGNumericError("Invalid image input. Expected vaddressmode data type to be SGDataType.string, but got \(vaddressmode.dataType).")
    }
    guard filtertype.dataType == SGDataType.string else {
        return SGNumericError("Invalid image input. Expected filtertype data type to be SGDataType.string, but got \(filtertype.dataType).")
    }
    let inputs: [SGNode.Input] = [
...
/// Inside
public func inside(_ in1: SGNumeric, mask: SGScalar) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
...
/// Natural Log
public func ln(_ in1: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.float {
...
/// Max
public func max(_ in1: SGNumeric, _ in2: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in1", connection: in1),
        .init(name: "in2", connection: in2),
    ]
...
/// Min
public func min(_ in1: SGNumeric, _ in2: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in1", connection: in1),
        .init(name: "in2", connection: in2),
    ]
...
/// Subtractive Mix
public func minus(fg: SGNumeric, bg: SGNumeric, mix: SGScalar) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
        .init(name: "mix", connection: mix),
...
/// Mix
public func mix(fg: SGNumeric, bg: SGNumeric, mix: SGScalar) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
        .init(name: "mix", connection: mix),
...
/// Modulo
public func modulo(_ in1: SGNumeric, _ in2: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in1", connection: in1),
        .init(name: "in2", connection: in2),
    ]
...
/// Multiply
public func multiply(_ in1: SGNumeric, _ in2: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in1", connection: in1),
        .init(name: "in2", connection: in2),
    ]
...
/// Noise 2D
public func noise2d(amplitude: SGNumeric, pivot: SGScalar, texcoord: SGVector) -> SGNumeric {
    guard pivot.dataType == SGDataType.float else {
        return SGNumericError("Invalid noise2d input. Expected pivot data type to be SGDataType.float, but got \(pivot.dataType).")
    }
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGNumericError("Invalid noise2d input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "amplitude", connection: amplitude),
        .init(name: "pivot", connection: pivot),
...
/// Noise 3D
public func noise3d(amplitude: SGNumeric, pivot: SGScalar, position: SGVector) -> SGNumeric {
    guard pivot.dataType == SGDataType.float else {
        return SGNumericError("Invalid noise3d input. Expected pivot data type to be SGDataType.float, but got \(pivot.dataType).")
    }
    guard position.dataType == SGDataType.vector3f else {
        return SGNumericError("Invalid noise3d input. Expected position data type to be SGDataType.vector3f, but got \(position.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "amplitude", connection: amplitude),
        .init(name: "pivot", connection: pivot),
...
public func normalmap(_ in1: SGVector, space: SGString, scale: SGNumeric, normal: SGVector, tangent: SGVector) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
...
/// Outside
public func outside(_ in1: SGNumeric, mask: SGScalar) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "mask", connection: mask),
    ]
...
/// Overlay
public func overlay(fg: SGNumeric, bg: SGNumeric, mix: SGScalar) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
        .init(name: "mix", connection: mix),
...
/// Additive Mix
public func plus(fg: SGNumeric, bg: SGNumeric, mix: SGScalar) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
        .init(name: "mix", connection: mix),
...
/// Power
public func power(_ in1: SGNumeric, _ in2: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in1", connection: in1),
        .init(name: "in2", connection: in2),
    ]
...
/// Ramp 4 Corners
public func ramp4(valuetl: SGNumeric, valuetr: SGNumeric, valuebl: SGNumeric, valuebr: SGNumeric, texcoord: SGVector) -> SGNumeric {
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGNumericError("Invalid ramp4 input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    let inputs: [SGNode.Input] = [
...
/// Ramp Horizontal
public func ramplr(valuel: SGNumeric, valuer: SGNumeric, texcoord: SGVector) -> SGNumeric {
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGNumericError("Invalid ramplr input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    let inputs: [SGNode.Input] = [
...
/// Ramp Vertical
public func ramptb(valuet: SGNumeric, valueb: SGNumeric, texcoord: SGVector) -> SGNumeric {
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGNumericError("Invalid ramptb input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    let inputs: [SGNode.Input] = [
...
/// Range
public func range(_ in1: SGNumeric, inlow: SGNumeric, inhigh: SGNumeric, gamma: SGNumeric, outlow: SGNumeric, outhigh: SGNumeric, doclamp: SGValue) -> SGNumeric {
    guard doclamp.dataType == SGDataType.bool else {
        return SGNumericError("Invalid range input. Expected doclamp data type to be SGDataType.bool, but got \(doclamp.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
...
/// Fractional
public func fractional(_ in1: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.color3f {
...
/// Camera Index Switch
public func geometrySwitchCameraindex(mono: SGNumeric, left: SGNumeric, right: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
...
/// One Minus
public func oneminus(_ in1: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.color3f {
...
/// Step
public func step(_ in1: SGNumeric, edge: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
...
/// Remap
public func remap(_ in1: SGNumeric, inlow: SGNumeric, inhigh: SGNumeric, outlow: SGNumeric, outhigh: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "inlow", connection: inlow),
        .init(name: "inhigh", connection: inhigh),
...
/// Round
public func round(_ in1: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.color3f {
...
/// Safe Power
public func safepower(_ in1: SGNumeric, _ in2: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in1", connection: in1),
        .init(name: "in2", connection: in2),
    ]
...
/// Screen
public func screen(fg: SGNumeric, bg: SGNumeric, mix: SGScalar) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
        .init(name: "mix", connection: mix),
...
/// Sign
public func sign(_ in1: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.color3f {
...
/// Sin
public func sin(_ in1: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.float {
...
/// Smooth Step
public func smoothstep(_ in1: SGNumeric, low: SGNumeric, high: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "low", connection: low),
        .init(name: "high", connection: high),
...
/// Split Horizontal
public func splitlr(valuel: SGNumeric, valuer: SGNumeric, center: SGScalar, texcoord: SGVector) -> SGNumeric {
    guard center.dataType == SGDataType.float else {
        return SGNumericError("Invalid splitlr input. Expected center data type to be SGDataType.float, but got \(center.dataType).")
    }
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGNumericError("Invalid splitlr input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "valuel", connection: valuel),
        .init(name: "valuer", connection: valuer),
...
/// Split Vertical
public func splittb(valuet: SGNumeric, valueb: SGNumeric, center: SGScalar, texcoord: SGVector) -> SGNumeric {
    guard center.dataType == SGDataType.float else {
        return SGNumericError("Invalid splittb input. Expected center data type to be SGDataType.float, but got \(center.dataType).")
    }
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGNumericError("Invalid splittb input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "valuet", connection: valuet),
        .init(name: "valueb", connection: valueb),
...
/// Square Root
public func sqrt(_ in1: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.float {
...
/// Subtract
public func subtract(_ in1: SGNumeric, _ in2: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in1", connection: in1),
        .init(name: "in2", connection: in2),
    ]
...
/// Switch
public func switchValue(_ in1: SGNumeric, _ in2: SGNumeric, _ in3: SGNumeric, _ in4: SGNumeric, _ in5: SGNumeric, _ in6: SGNumeric, _ in7: SGNumeric, _ in8: SGNumeric, _ in9: SGNumeric, _ in10: SGNumeric, which: SGScalar) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in1", connection: in1),
        .init(name: "in2", connection: in2),
...
/// Tan
public func tan(_ in1: SGNumeric) -> SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.float {
...
/// Tiled Image
public func tiledimage(file: SGTexture, defaultValue: SGNumeric, texcoord: SGVector, uvtiling: SGVector, uvoffset: SGVector, realworldimagesize: SGVector, realworldtilesize: SGVector, filtertype: SGString) -> SGNumeric {
    guard file.dataType == SGDataType.asset else {
        return SGNumericError("Invalid tiledimage input. Expected file data type to be SGDataType.asset, but got \(file.dataType).")
    }
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGNumericError("Invalid tiledimage input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    guard uvtiling.dataType == SGDataType.vector2f else {
        return SGNumericError("Invalid tiledimage input. Expected uvtiling data type to be SGDataType.vector2f, but got \(uvtiling.dataType).")
    }
    guard uvoffset.dataType == SGDataType.vector2f else {
        return SGNumericError("Invalid tiledimage input. Expected uvoffset data type to be SGDataType.vector2f, but got \(uvoffset.dataType).")
    }
    guard realworldimagesize.dataType == SGDataType.vector2f else {
        return SGNumericError("Invalid tiledimage input. Expected realworldimagesize data type to be SGDataType.vector2f, but got \(realworldimagesize.dataType).")
    }
    guard realworldtilesize.dataType == SGDataType.vector2f else {
        return SGNumericError("Invalid tiledimage input. Expected realworldtilesize data type to be SGDataType.vector2f, but got \(realworldtilesize.dataType).")
    }
    guard filtertype.dataType == SGDataType.string else {
        return SGNumericError("Invalid tiledimage input. Expected filtertype data type to be SGDataType.string, but got \(filtertype.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "file", connection: file),
        .init(name: "default", connection: defaultValue),
...
public func triplanarprojection(filex: SGTexture, filey: SGTexture, filez: SGTexture, defaultValue: SGNumeric, position: SGVector, normal: SGVector, filtertype: SGString) -> SGNumeric {
    guard filex.dataType == SGDataType.asset else {
        return SGNumericError("Invalid triplanarprojection input. Expected filex data type to be SGDataType.asset, but got \(filex.dataType).")
    }
    guard filey.dataType == SGDataType.asset else {
        return SGNumericError("Invalid triplanarprojection input. Expected filey data type to be SGDataType.asset, but got \(filey.dataType).")
    }
    guard filez.dataType == SGDataType.asset else {
        return SGNumericError("Invalid triplanarprojection input. Expected filez data type to be SGDataType.asset, but got \(filez.dataType).")
    }
    guard position.dataType == SGDataType.vector3f else {
        return SGNumericError("Invalid triplanarprojection input. Expected position data type to be SGDataType.vector3f, but got \(position.dataType).")
    }
    guard normal.dataType == SGDataType.vector3f else {
        return SGNumericError("Invalid triplanarprojection input. Expected normal data type to be SGDataType.vector3f, but got \(normal.dataType).")
    }
    guard filtertype.dataType == SGDataType.string else {
        return SGNumericError("Invalid triplanarprojection input. Expected filtertype data type to be SGDataType.string, but got \(filtertype.dataType).")
    }
    let inputs: [SGNode.Input] = [
...
/// Worley Noise 2D
public func worleynoise2d(texcoord: SGVector, jitter: SGScalar) -> SGNumeric {
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGNumericError("Invalid worleynoise2d input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType).")
    }
    guard jitter.dataType == SGDataType.float else {
        return SGNumericError("Invalid worleynoise2d input. Expected jitter data type to be SGDataType.float, but got \(jitter.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "texcoord", connection: texcoord),
...
/// Worley Noise 3D
public func worleynoise3d(position: SGVector, jitter: SGScalar) -> SGNumeric {
    guard position.dataType == SGDataType.vector3f else {
        return SGNumericError("Invalid worleynoise3d input. Expected position data type to be SGDataType.vector3f, but got \(position.dataType).")
    }
    guard jitter.dataType == SGDataType.float else {
        return SGNumericError("Invalid worleynoise3d input. Expected jitter data type to be SGDataType.float, but got \(jitter.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "position", connection: position),
        .init(name: "jitter", connection: jitter),
