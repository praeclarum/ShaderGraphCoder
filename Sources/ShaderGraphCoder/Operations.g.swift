...
import Foundation
public enum SGEnum0_constant_clamp_periodic_mirror: String, CaseIterable {
    case clamp = "clamp"
    case constant = "constant"
    case mirror = "mirror"
    case periodic = "periodic"
}
public enum SGEnum1_closest_linear_cubic: String, CaseIterable {
    case closest = "closest"
    case cubic = "cubic"
    case linear = "linear"
}
public enum SGEnum2_model_object_world_tangent: String, CaseIterable {
    case model = "model"
    case object = "object"
    case tangent = "tangent"
    case world = "world"
}
public enum SGEnum3_model_object_world_unspecified: String, CaseIterable {
    case model = "model"
    case object = "object"
    case unspecified = "unspecified"
    case world = "world"
}
public enum SGEnum4_box_gaussian: String, CaseIterable {
    case box = "box"
    case gaussian = "gaussian"
}
public enum SGEnum5_tangent_object: String, CaseIterable {
    case object = "object"
    case tangent = "tangent"
}
public enum SGEnum6_black_clamp_periodic: String, CaseIterable {
    case black = "black"
    case clamp = "clamp"
    case periodic = "periodic"
}
public enum SGEnum7_repeat_mirrored_repeat_clamp_to_edge_clamp_to_zero_clamp_to_border: String, CaseIterable {
...
public enum SGEnum8_transparent_black_opaque_black_opaque_white: String, CaseIterable {
    case opaqueBlack = "opaque_black"
    case opaqueWhite = "opaque_white"
    case transparentBlack = "transparent_black"
}
public enum SGEnum9_nearest_linear: String, CaseIterable {
    case linear = "linear"
    case nearest = "nearest"
}
public enum SGEnum10_none_nearest_linear: String, CaseIterable {
    case linear = "linear"
    case nearest = "nearest"
    case none = "none"
}
public enum SGEnum11_clamp_to_edge_clamp_to_zero_clamp_to_border: String, CaseIterable {
    case clampToBorder = "clamp_to_border"
    case clampToEdge = "clamp_to_edge"
    case clampToZero = "clamp_to_zero"
}
...
public func bitangent(space: SGEnum2_model_object_world_tangent, index: SGScalar) -> SGVector {
...
/// Blur
public func blur<T>(_ in1: T, size: SGScalar, filtertype: SGEnum4_box_gaussian) -> T where T: SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
...
/// Image
public func image<T>(file: SGTexture, defaultValue: T, texcoord: SGVector, uaddressmode: SGEnum0_constant_clamp_periodic_mirror, vaddressmode: SGEnum0_constant_clamp_periodic_mirror, filtertype: SGEnum1_closest_linear_cubic) -> T where T: SGNumeric {
...
public func normal(space: SGEnum2_model_object_world_tangent) -> SGVector {
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: SGString(source: .constant(.string(space.rawValue)))),
    ]
    return SGVector(source: .nodeOutput(SGNode(
...
public func normalmap(_ in1: SGVector, space: SGEnum5_tangent_object, scale: SGNumeric, normal: SGVector, tangent: SGVector) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
...
public func position(space: SGEnum2_model_object_world_tangent) -> SGVector {
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: SGString(source: .constant(.string(space.rawValue)))),
    ]
    return SGVector(source: .nodeOutput(SGNode(
...
/// Camera Position
public func cameraposition(space: SGEnum2_model_object_world_tangent) -> SGVector {
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: SGString(source: .constant(.string(space.rawValue)))),
    ]
    return SGVector(source: .nodeOutput(SGNode(
...
/// View Direction
public func viewdirection(space: SGEnum2_model_object_world_tangent) -> SGVector {
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: SGString(source: .constant(.string(space.rawValue)))),
    ]
    return SGVector(source: .nodeOutput(SGNode(
...
public func tangent(space: SGEnum2_model_object_world_tangent, index: SGScalar) -> SGVector {
    guard index.dataType == SGDataType.int else {
...
/// Tiled Image
public func tiledimage<T>(file: SGTexture, defaultValue: T, texcoord: SGVector, uvtiling: SGVector, uvoffset: SGVector, realworldimagesize: SGVector, realworldtilesize: SGVector, filtertype: SGEnum1_closest_linear_cubic) -> T where T: SGNumeric {
    guard file.dataType == SGDataType.asset else {
...
public func transformnormal(_ in1: SGVector, fromspace: SGEnum3_model_object_world_unspecified, tospace: SGEnum3_model_object_world_unspecified) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
...
public func transformpoint(_ in1: SGVector, fromspace: SGEnum3_model_object_world_unspecified, tospace: SGEnum3_model_object_world_unspecified) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
...
public func transformvector(_ in1: SGVector, fromspace: SGEnum3_model_object_world_unspecified, tospace: SGEnum3_model_object_world_unspecified) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
...
public func triplanarprojection<T>(filex: SGTexture, filey: SGTexture, filez: SGTexture, defaultValue: T, position: SGVector, normal: SGVector, filtertype: SGEnum1_closest_linear_cubic) -> T where T: SGNumeric {
...
public func updirection(space: SGEnum2_model_object_world_tangent) -> SGVector {
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: SGString(source: .constant(.string(space.rawValue)))),
    ]
    return SGVector(source: .nodeOutput(SGNode(
