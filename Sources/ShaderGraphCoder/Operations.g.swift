...
public func bitangent(space: SGString, index: SGScalar) -> SGVector {
    guard space.dataType == SGDataType.string else {
        return SGVector(source: .error("Invalid bitangent input. Expected space data type to be SGDataType.string, but got \(space.dataType)."))
    }
...
/// Blur
public func blur<T>(_ in1: T, size: SGScalar, filtertype: SGString) -> T where T: SGNumeric {
    guard filtertype.dataType == SGDataType.string else {
        return T(source: .error("Invalid blur input. Expected filtertype data type to be SGDataType.string, but got \(filtertype.dataType)."))
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
...
/// Burn
public func burn<T>(fg: T, bg: T, mix: SGScalar) -> T where T: SGNumeric {
    let inputs: [SGNode.Input] = [
...
/// Difference
public func difference<T>(fg: T, bg: T, mix: SGScalar) -> T where T: SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
        .init(name: "mix", connection: mix),
...
/// Dodge
public func dodge<T>(fg: T, bg: T, mix: SGScalar) -> T where T: SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
        .init(name: "mix", connection: mix),
...
/// If Equal
public func ifequal<T>(value1: SGValue, value2: SGValue, in1: T, in2: T) -> T where T: SGNumeric {
    let inputs: [SGNode.Input] = [
...
/// If Greater
public func ifgreater<T>(value1: SGScalar, value2: SGScalar, in1: T, in2: T) -> T where T: SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "value1", connection: value1),
        .init(name: "value2", connection: value2),
        .init(name: "in1", connection: in1),
...
/// If Greater Or Equal
public func ifgreatereq<T>(value1: SGScalar, value2: SGScalar, in1: T, in2: T) -> T where T: SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "value1", connection: value1),
        .init(name: "value2", connection: value2),
        .init(name: "in1", connection: in1),
    ...
    return T(source: .error("Unsupported input data types for ifgreatereq"))
}
/// Image
public func image<T>(file: SGTexture, defaultValue: T, texcoord: SGVector, uaddressmode: SGString, vaddressmode: SGString, filtertype: SGString) -> T where T: SGNumeric {
    ...
    guard uaddressmode.dataType == SGDataType.string else {
        return T(source: .error("Invalid image input. Expected uaddressmode data type to be SGDataType.string, but got \(uaddressmode.dataType)."))
    }
    guard vaddressmode.dataType == SGDataType.string else {
        return T(source: .error("Invalid image input. Expected vaddressmode data type to be SGDataType.string, but got \(vaddressmode.dataType)."))
    }
    guard filtertype.dataType == SGDataType.string else {
        return T(source: .error("Invalid image input. Expected filtertype data type to be SGDataType.string, but got \(filtertype.dataType)."))
    }
    let inputs: [SGNode.Input] = [
...
/// Inside
public func inside<T>(_ in1: T, mask: SGScalar) -> T where T: SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
...
/// Subtractive Mix
public func minus<T>(fg: T, bg: T, mix: SGScalar) -> T where T: SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
        .init(name: "mix", connection: mix),
...
/// Mix
public func mix<T>(fg: T, bg: T, mix: SGScalar) -> T where T: SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
        .init(name: "mix", connection: mix),
...
public func normal(space: SGString) -> SGVector {
    guard space.dataType == SGDataType.string else {
        return SGVector(source: .error("Invalid normal input. Expected space data type to be SGDataType.string, but got \(space.dataType)."))
    }
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: space),
    ]
...
public func normalmap(_ in1: SGVector, space: SGString, scale: SGNumeric, normal: SGVector, tangent: SGVector) -> SGVector {
    ...
    guard space.dataType == SGDataType.string else {
        return SGVector(source: .error("Invalid normalmap input. Expected space data type to be SGDataType.string, but got \(space.dataType)."))
    }
...
/// Outside
public func outside<T>(_ in1: T, mask: SGScalar) -> T where T: SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "mask", connection: mask),
    ]
...
/// Overlay
public func overlay<T>(fg: T, bg: T, mix: SGScalar) -> T where T: SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
        .init(name: "mix", connection: mix),
...
/// Additive Mix
public func plus<T>(fg: T, bg: T, mix: SGScalar) -> T where T: SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
        .init(name: "mix", connection: mix),
...
public func position(space: SGString) -> SGVector {
    guard space.dataType == SGDataType.string else {
        return SGVector(source: .error("Invalid position input. Expected space data type to be SGDataType.string, but got \(space.dataType)."))
    }
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: space),
    ]
...
/// Ramp 4 Corners
public func ramp4<T>(valuetl: T, valuetr: T, valuebl: T, valuebr: T, texcoord: SGVector) -> T where T: SGNumeric {
    guard texcoord.dataType == SGDataType.vector2f else {
...
/// Ramp Horizontal
public func ramplr<T>(valuel: T, valuer: T, texcoord: SGVector) -> T where T: SGNumeric {
    guard texcoord.dataType == SGDataType.vector2f else {
...
/// Ramp Vertical
public func ramptb<T>(valuet: T, valueb: T, texcoord: SGVector) -> T where T: SGNumeric {
    guard texcoord.dataType == SGDataType.vector2f else {
...
/// Range
public func range<T>(_ in1: T, inlow: SGNumeric, inhigh: SGNumeric, gamma: SGNumeric, outlow: SGNumeric, outhigh: SGNumeric, doclamp: SGValue) -> T where T: SGNumeric {
...
public func cameraposition(space: SGString) -> SGVector {
    guard space.dataType == SGDataType.string else {
        return SGVector(source: .error("Invalid cameraposition input. Expected space data type to be SGDataType.string, but got \(space.dataType)."))
    }
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: space),
    ]
...
public func viewdirection(space: SGString) -> SGVector {
    guard space.dataType == SGDataType.string else {
        return SGVector(source: .error("Invalid viewdirection input. Expected space data type to be SGDataType.string, but got \(space.dataType)."))
    }
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: space),
    ]
...
/// Screen
public func screen<T>(fg: T, bg: T, mix: SGScalar) -> T where T: SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
        .init(name: "mix", connection: mix),
...
/// Split Horizontal
public func splitlr<T>(valuel: T, valuer: T, center: SGScalar, texcoord: SGVector) -> T where T: SGNumeric {
...
/// Split Vertical
public func splittb<T>(valuet: T, valueb: T, center: SGScalar, texcoord: SGVector) -> T where T: SGNumeric {
    guard center.dataType == SGDataType.float else {
...
/// Switch
public func switchValue<T>(_ in1: T, _ in2: T, _ in3: T, _ in4: T, _ in5: T, _ in6: T, _ in7: T, _ in8: T, _ in9: T, _ in10: T, which: SGScalar) -> T where T: SGNumeric {
    let inputs: [SGNode.Input] = [
        .init(name: "in1", connection: in1),
        .init(name: "in2", connection: in2),
...
public func tangent(space: SGString, index: SGScalar) -> SGVector {
    guard space.dataType == SGDataType.string else {
        return SGVector(source: .error("Invalid tangent input. Expected space data type to be SGDataType.string, but got \(space.dataType)."))
    }
    guard index.dataType == SGDataType.int else {
...
/// Tiled Image
public func tiledimage<T>(file: SGTexture, defaultValue: T, texcoord: SGVector, uvtiling: SGVector, uvoffset: SGVector, realworldimagesize: SGVector, realworldtilesize: SGVector, filtertype: SGString) -> T where T: SGNumeric {
    guard file.dataType == SGDataType.asset else {
    ...
    guard filtertype.dataType == SGDataType.string else {
        return T(source: .error("Invalid tiledimage input. Expected filtertype data type to be SGDataType.string, but got \(filtertype.dataType)."))
    }
    let inputs: [SGNode.Input] = [
        .init(name: "file", connection: file),
        .init(name: "default", connection: defaultValue),
...
public func transformnormal(_ in1: SGVector, fromspace: SGString, tospace: SGString) -> SGVector {
    ...
    guard fromspace.dataType == SGDataType.string else {
        return SGVector(source: .error("Invalid transformnormal input. Expected fromspace data type to be SGDataType.string, but got \(fromspace.dataType)."))
    }
    guard tospace.dataType == SGDataType.string else {
        return SGVector(source: .error("Invalid transformnormal input. Expected tospace data type to be SGDataType.string, but got \(tospace.dataType)."))
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
...
public func transformpoint(_ in1: SGVector, fromspace: SGString, tospace: SGString) -> SGVector {
    ...
    guard fromspace.dataType == SGDataType.string else {
        return SGVector(source: .error("Invalid transformpoint input. Expected fromspace data type to be SGDataType.string, but got \(fromspace.dataType)."))
    }
    guard tospace.dataType == SGDataType.string else {
        return SGVector(source: .error("Invalid transformpoint input. Expected tospace data type to be SGDataType.string, but got \(tospace.dataType)."))
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "fromspace", connection: fromspace),
...
public func transformvector(_ in1: SGVector, fromspace: SGString, tospace: SGString) -> SGVector {
    ...
    guard fromspace.dataType == SGDataType.string else {
        return SGVector(source: .error("Invalid transformvector input. Expected fromspace data type to be SGDataType.string, but got \(fromspace.dataType)."))
    }
    guard tospace.dataType == SGDataType.string else {
        return SGVector(source: .error("Invalid transformvector input. Expected tospace data type to be SGDataType.string, but got \(tospace.dataType)."))
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "fromspace", connection: fromspace),
...
public func triplanarprojection<T>(filex: SGTexture, filey: SGTexture, filez: SGTexture, defaultValue: T, position: SGVector, normal: SGVector, filtertype: SGString) -> T where T: SGNumeric {
    ...
    guard filtertype.dataType == SGDataType.string else {
        return T(source: .error("Invalid triplanarprojection input. Expected filtertype data type to be SGDataType.string, but got \(filtertype.dataType)."))
    }
    let inputs: [SGNode.Input] = [
...
public func updirection(space: SGString) -> SGVector {
    guard space.dataType == SGDataType.string else {
        return SGVector(source: .error("Invalid updirection input. Expected space data type to be SGDataType.string, but got \(space.dataType)."))
    }
    let inputs: [SGNode.Input] = [
        .init(name: "space", connection: space),
    ]
...
public func worleynoise2d(texcoord: SGVector, jitter: SGScalar) -> SGNumeric {
    guard texcoord.dataType == SGDataType.vector2f else {
        return SGNumeric(source: .error("Invalid worleynoise2d input. Expected texcoord data type to be SGDataType.vector2f, but got \(texcoord.dataType)."))
    }
    guard jitter.dataType == SGDataType.float else {
        return SGNumeric(source: .error("Invalid worleynoise2d input. Expected jitter data type to be SGDataType.float, but got \(jitter.dataType)."))
    }
    let inputs: [SGNode.Input] = [
        .init(name: "texcoord", connection: texcoord),
...
public func worleynoise3d(position: SGVector, jitter: SGScalar) -> SGNumeric {
    guard position.dataType == SGDataType.vector3f else {
        return SGNumeric(source: .error("Invalid worleynoise3d input. Expected position data type to be SGDataType.vector3f, but got \(position.dataType)."))
    }
    guard jitter.dataType == SGDataType.float else {
        return SGNumeric(source: .error("Invalid worleynoise3d input. Expected jitter data type to be SGDataType.float, but got \(jitter.dataType)."))
    }
    let inputs: [SGNode.Input] = [
        .init(name: "position", connection: position),
        .init(name: "jitter", connection: jitter),
