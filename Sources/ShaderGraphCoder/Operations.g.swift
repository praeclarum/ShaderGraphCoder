...
public func RealityKitTexture2DPixelGradient(file: TextureResource, u_wrap_mode: SGString, v_wrap_mode: SGString, border_color: SGString, filter: SGString, max_anisotropy: SGScalar, max_lod_clamp: SGScalar, min_lod_clamp: SGScalar, defaultValue: SGValue, texcoord: SGVector, dynamic_min_lod_clamp: SGScalar, gradient_dPdx: SGVector, gradient_dPdy: SGVector, offset: SGVector) -> SGValue {
    guard file.dataType == SGDataType.asset else {
...
public func RealityKitTexture2DPixelLOD(file: TextureResource, u_wrap_mode: SGString, v_wrap_mode: SGString, border_color: SGString, filter: SGString, max_anisotropy: SGScalar, max_lod_clamp: SGScalar, min_lod_clamp: SGScalar, defaultValue: SGValue, texcoord: SGVector, lod: SGScalar, offset: SGVector) -> SGValue {
    guard file.dataType == SGDataType.asset else {
...
public func RealityKitTexture2DPixel(file: TextureResource, u_wrap_mode: SGString, v_wrap_mode: SGString, border_color: SGString, filter: SGString, max_anisotropy: SGScalar, max_lod_clamp: SGScalar, min_lod_clamp: SGScalar, defaultValue: SGValue, texcoord: SGVector, bias: SGScalar, dynamic_min_lod_clamp: SGScalar, offset: SGVector) -> SGValue {
    guard file.dataType == SGDataType.asset else {
...
public func RealityKitTexture2D(file: TextureResource, u_wrap_mode: SGString, v_wrap_mode: SGString, border_color: SGString, mag_filter: SGString, min_filter: SGString, mip_filter: SGString, max_anisotropy: SGScalar, max_lod_clamp: SGScalar, min_lod_clamp: SGScalar, defaultValue: SGValue, texcoord: SGVector, bias: SGScalar, dynamic_min_lod_clamp: SGScalar, offset: SGVector) -> SGValue {
    guard file.dataType == SGDataType.asset else {
...
public func RealityKitTextureCubeGradient(file: TextureResource, u_wrap_mode: SGString, v_wrap_mode: SGString, border_color: SGString, mag_filter: SGString, min_filter: SGString, mip_filter: SGString, max_anisotropy: SGScalar, max_lod_clamp: SGScalar, min_lod_clamp: SGScalar, defaultValue: SGValue, texcoord: SGVector, dynamic_min_lod_clamp: SGScalar, gradientcube_dPdx: SGVector, gradientcube_dPdy: SGVector) -> SGValue {
    guard file.dataType == SGDataType.asset else {
...
public func RealityKitTextureRead(file: TextureResource, defaultValue: SGValue, x: SGScalar, y: SGScalar, lod: SGScalar) -> SGValue {
    guard file.dataType == SGDataType.asset else {
...
public func UsdTransform2d(_ in1: SGVector, rotation: SGScalar, scale: SGVector, translation: SGVector) -> SGVector {
    guard in1.dataType == SGDataType.vector2f else {
        return SGError("Invalid UsdTransform2d input. Expected in data type to be SGDataType.vector2f, but got \(in1.dataType).")
    }
...
public func determinant(_ in1: SGValue) -> SGScalar {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.matrix22f {
        return SGScalar(source: .nodeOutput(SGNode(
            nodeType: "ND_determinant_matrix22",
            inputs: inputs,
            outputs: [.init(dataType: SGDataType.float)])))
    }
    if in1.dataType == SGDataType.matrix33f {
        return SGScalar(source: .nodeOutput(SGNode(
            nodeType: "ND_determinant_matrix33",
            inputs: inputs,
            outputs: [.init(dataType: SGDataType.float)])))
    }
    if in1.dataType == SGDataType.matrix44f {
        return SGScalar(source: .nodeOutput(SGNode(
...
public func heighttonormal(_ in1: SGScalar, scale: SGScalar) -> SGVector {
    guard in1.dataType == SGDataType.float else {
        return SGError("Invalid heighttonormal input. Expected in data type to be SGDataType.float, but got \(in1.dataType).")
    }
...
public func image(file: TextureResource, layer: SGString, defaultValue: SGValue, texcoord: SGVector, uaddressmode: SGString, vaddressmode: SGString, filtertype: SGString, framerange: SGString, frameoffset: SGScalar, frameendaction: SGString) -> SGValue {
    guard file.dataType == SGDataType.asset else {
...
public func mixColor(fg: SGColor, bg: SGColor, mix: SGScalar) -> SGColor {
    guard fg.dataType == SGDataType.color4f else {
        return SGError("Invalid mixColor input. Expected fg data type to be SGDataType.color4f, but got \(fg.dataType).")
    }
    guard bg.dataType == SGDataType.color4f else {
        return SGError("Invalid mixColor input. Expected bg data type to be SGDataType.color4f, but got \(bg.dataType).")
    }
    guard mix.dataType == SGDataType.float else {
        return SGError("Invalid mixColor input. Expected mix data type to be SGDataType.float, but got \(mix.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "fg", connection: fg),
        .init(name: "bg", connection: bg),
...
public func invertmatrix(_ in1: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.matrix22f {
...
public func normal_map_decode(_ in1: SGVector) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
        return SGError("Invalid normal_map_decode input. Expected in data type to be SGDataType.vector3f, but got \(in1.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
...
public func normalmap(_ in1: SGVector, space: SGString, scale: SGValue, normal: SGVector, tangent: SGVector) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
        return SGError("Invalid normalmap input. Expected in data type to be SGDataType.vector3f, but got \(in1.dataType).")
    }
    guard space.dataType == SGDataType.string else {
...
public func premult(_ in1: SGColor) -> SGColor {
    guard in1.dataType == SGDataType.color4f else {
        return SGError("Invalid premult input. Expected in data type to be SGDataType.color4f, but got \(in1.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
...
public func cubeimage(file: TextureResource, defaultValue: SGValue, texcoord: SGVector, filtertype: SGString) -> SGValue {
    guard file.dataType == SGDataType.asset else {
...
public func image_bias(file: TextureResource, defaultValue: SGValue, texcoord: SGVector, bias: SGScalar, coord: SGString, s_address: SGString, t_address: SGString, border_color: SGString, mag_filter: SGString, min_filter: SGString, mip_filter: SGString, max_anisotropy: SGScalar, lod_min: SGScalar, lod_max: SGScalar) -> SGValue {
    guard file.dataType == SGDataType.asset else {
...
public func image_bias_min_lod_clamp(file: TextureResource, defaultValue: SGValue, texcoord: SGVector, bias: SGScalar, min_lod_clamp: SGScalar, coord: SGString, s_address: SGString, t_address: SGString, border_color: SGString, mag_filter: SGString, min_filter: SGString, mip_filter: SGString, max_anisotropy: SGScalar, lod_min: SGScalar, lod_max: SGScalar) -> SGValue {
    guard file.dataType == SGDataType.asset else {
...
public func image(file: TextureResource, defaultValue: SGValue, texcoord: SGVector, coord: SGString, s_address: SGString, t_address: SGString, border_color: SGString, mag_filter: SGString, min_filter: SGString, mip_filter: SGString, max_anisotropy: SGScalar, lod_min: SGScalar, lod_max: SGScalar) -> SGValue {
    guard file.dataType == SGDataType.asset else {
        return SGError("Invalid image input. Expected file data type to be SGDataType.asset, but got \(file.dataType).")
    }
    guard texcoord.dataType == SGDataType.vector2f else {
...
public func image_gradient2d(file: TextureResource, defaultValue: SGValue, texcoord: SGVector, gradient2d_x: SGString, gradient2d_y: SGString, coord: SGString, s_address: SGString, t_address: SGString, border_color: SGString, mag_filter: SGString, min_filter: SGString, mip_filter: SGString, max_anisotropy: SGScalar, lod_min: SGScalar, lod_max: SGScalar) -> SGValue {
    guard file.dataType == SGDataType.asset else {
...
public func image_gradient2d_min_lod_clamp(file: TextureResource, defaultValue: SGValue, texcoord: SGVector, gradient2d_x: SGString, gradient2d_y: SGString, min_lod_clamp: SGScalar, coord: SGString, s_address: SGString, t_address: SGString, border_color: SGString, mag_filter: SGString, min_filter: SGString, mip_filter: SGString, max_anisotropy: SGScalar, lod_min: SGScalar, lod_max: SGScalar) -> SGValue {
    guard file.dataType == SGDataType.asset else {
...
public func image_lod(file: TextureResource, defaultValue: SGValue, texcoord: SGVector, level: SGScalar, coord: SGString, s_address: SGString, t_address: SGString, border_color: SGString, mag_filter: SGString, min_filter: SGString, mip_filter: SGString, max_anisotropy: SGScalar, lod_min: SGScalar, lod_max: SGScalar) -> SGValue {
    guard file.dataType == SGDataType.asset else {
...
public func image_min_lod_clamp(file: TextureResource, defaultValue: SGValue, texcoord: SGVector, min_lod_clamp: SGScalar, coord: SGString, s_address: SGString, t_address: SGString, border_color: SGString, mag_filter: SGString, min_filter: SGString, mip_filter: SGString, max_anisotropy: SGScalar, lod_min: SGScalar, lod_max: SGScalar) -> SGValue {
    guard file.dataType == SGDataType.asset else {
...
public func logical_not(_ in1: SGValue) -> SGValue {
    guard in1.dataType == SGDataType.bool else {
        return SGError("Invalid logical_not input. Expected in data type to be SGDataType.bool, but got \(in1.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
...
public func reflect(_ in1: SGVector, normal: SGVector) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
        return SGError("Invalid reflect input. Expected in data type to be SGDataType.vector3f, but got \(in1.dataType).")
    }
    guard normal.dataType == SGDataType.vector3f else {
...
public func refract(_ in1: SGVector, normal: SGVector, eta: SGScalar) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
        return SGError("Invalid refract input. Expected in data type to be SGDataType.vector3f, but got \(in1.dataType).")
    }
    guard normal.dataType == SGDataType.vector3f else {
...
public func rotate2d(_ in1: SGVector, amount: SGScalar) -> SGVector {
    guard in1.dataType == SGDataType.vector2f else {
        return SGError("Invalid rotate2d input. Expected in data type to be SGDataType.vector2f, but got \(in1.dataType).")
    }
...
public func rotate3d(_ in1: SGVector, amount: SGScalar, axis: SGVector) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
        return SGError("Invalid rotate3d input. Expected in data type to be SGDataType.vector3f, but got \(in1.dataType).")
    }
    guard amount.dataType == SGDataType.float else {
...
public func switchValue(_ in1: SGValue, _ in2: SGValue, _ in3: SGValue, _ in4: SGValue, _ in5: SGValue, _ in6: SGValue, _ in7: SGValue, _ in8: SGValue, _ in9: SGValue, _ in10: SGValue, which: SGScalar) -> SGValue {
    ...
    return SGError("Unsupported input data types for switchValue")
}
...
public func tiledimage(file: TextureResource, defaultValue: SGValue, texcoord: SGVector, uvtiling: SGVector, uvoffset: SGVector, realworldimagesize: SGVector, realworldtilesize: SGVector, filtertype: SGString, framerange: SGString, frameoffset: SGScalar, frameendaction: SGString) -> SGValue {
    guard file.dataType == SGDataType.asset else {
...
public func transformmatrix(_ in1: SGVector, mat: SGValue) -> SGVector {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
        .init(name: "mat", connection: mat),
    ]
    if in1.dataType == SGDataType.vector2f && mat.dataType == SGDataType.matrix22f {
        return SGVector(source: .nodeOutput(SGNode(
            nodeType: "ND_transformmatrix_vector2",
            inputs: inputs,
            outputs: [.init(dataType: SGDataType.vector2f)])))
    }
    if in1.dataType == SGDataType.vector3f && mat.dataType == SGDataType.matrix33f {
        return SGVector(source: .nodeOutput(SGNode(
            nodeType: "ND_transformmatrix_vector3",
            inputs: inputs,
            outputs: [.init(dataType: SGDataType.vector3f)])))
    }
    if in1.dataType == SGDataType.vector4f && mat.dataType == SGDataType.matrix44f {
        return SGVector(source: .nodeOutput(SGNode(
...
public func transformmatrix_vector2M3(_ in1: SGVector, mat: SGValue) -> SGVector {
    guard in1.dataType == SGDataType.vector2f else {
        return SGError("Invalid transformmatrix_vector2M3 input. Expected in data type to be SGDataType.vector2f, but got \(in1.dataType).")
    }
...
public func transformmatrix_vector3M4(_ in1: SGVector, mat: SGValue) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
        return SGError("Invalid transformmatrix_vector3M4 input. Expected in data type to be SGDataType.vector3f, but got \(in1.dataType).")
    }
...
public func transformnormal(_ in1: SGVector, fromspace: SGString, tospace: SGString) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
        return SGError("Invalid transformnormal input. Expected in data type to be SGDataType.vector3f, but got \(in1.dataType).")
    }
...
public func transformpoint(_ in1: SGVector, fromspace: SGString, tospace: SGString) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
        return SGError("Invalid transformpoint input. Expected in data type to be SGDataType.vector3f, but got \(in1.dataType).")
    }
    guard fromspace.dataType == SGDataType.string else {
...
public func transformvector(_ in1: SGVector, fromspace: SGString, tospace: SGString) -> SGVector {
    guard in1.dataType == SGDataType.vector3f else {
        return SGError("Invalid transformvector input. Expected in data type to be SGDataType.vector3f, but got \(in1.dataType).")
    }
    guard fromspace.dataType == SGDataType.string else {
...
public func transpose(_ in1: SGValue) -> SGValue {
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
    if in1.dataType == SGDataType.matrix22f {
...
public func triplanarprojection(filex: TextureResource, filey: TextureResource, filez: TextureResource, layerx: SGString, layery: SGString, layerz: SGString, defaultValue: SGValue, position: SGVector, normal: SGVector, filtertype: SGString, framerange: SGString, frameoffset: SGScalar, frameendaction: SGString) -> SGValue {
...
public func unpremult(_ in1: SGColor) -> SGColor {
    guard in1.dataType == SGDataType.color4f else {
        return SGError("Invalid unpremult input. Expected in data type to be SGDataType.color4f, but got \(in1.dataType).")
    }
    let inputs: [SGNode.Input] = [
        .init(name: "in", connection: in1),
    ]
